...
TEST_F(transformation_tests, finite_diff_sum_of_squares_2D)
{
  ...
  EXPECT_TRUE(is_near(t.jacobian(M2(3, 4), M1(0.2)), f.jacobian(M2(3, 4), M1(0.2))));
  EXPECT_TRUE(is_near(t.jacobian(M2(1, 2), M1(0.1), M1(0.2)), f.jacobian(M2(1, 2), M1(0.1), M1(0.2))));
  EXPECT_TRUE(is_near(t.jacobian(M2(3, 4), M1(0.3), M1(0.4)), f.jacobian(M2(3, 4), M1(0.3), M1(0.4))));
}
