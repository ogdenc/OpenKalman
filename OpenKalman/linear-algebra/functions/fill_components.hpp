...
namespace OpenKalman
{
  ...
  template<Layout layout = Layout::right, indexible Arg, value::number ... S> requires
  ...
  template<Layout layout = Layout::right, typename Arg, typename...S, std::enable_if_t<
    indexible<Arg> and (value::number<S> and ...) and (layout == Layout::right or layout == Layout::left) and
