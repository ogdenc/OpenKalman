...
TEST(arrays, mdspan)
{
  ...
  auto mdspan_a23c = get_mdspan(a23c);
  using Mdspan_a23 = decltype(mdspan_a23);
  using Mdspan_a23c = decltype(mdspan_a23c);
  ...
  static_assert(stdcompat::same_as<Mdspan_a23::element_type, double>);
  static_assert(stdcompat::same_as<Mdspan_a23c::element_type, const double>);

  static_assert(stdcompat::same_as<Mdspan_a23::element_type, double>);
  static_assert(stdcompat::same_as<Mdspan_a23c::element_type, const double>);

  static_assert(Mdspan_a23::rank() == 2);
  static_assert(Mdspan_a23c::rank() == 2);

  static_assert(stdcompat::same_as<Mdspan_a23::layout_type, stdcompat::layout_right>);
  static_assert(stdcompat::same_as<Mdspan_a23c::layout_type, stdcompat::layout_right>);
}
...
TEST(arrays, basic_characteristics)
{
  ...
  static_assert(stdcompat::same_as<element_type_of_t<A23>, double>);
  static_assert(stdcompat::same_as<element_type_of_t<A23c>, const double>);

  static_assert(stdcompat::same_as<layout_of_t<A23>, stdcompat::layout_right>);
  static_assert(stdcompat::same_as<layout_of_t<A23c>, stdcompat::layout_right>);

  static_assert(writable<A23>);
  static_assert(not writable<A23c>);
}
...
TEST(arrays, get_pattern_collection)
{
  ...
  static_assert(vector_space_descriptors_match(a23, a23c));

  static_assert(coordinates::euclidean_pattern_collection<decltype(get_pattern_collection(a23))>);
  static_assert(coordinates::fixed_pattern_collection<decltype(get_pattern_collection(a23))>);
  static_assert(collections::index<decltype(get_pattern_collection(a23))>);
  static_assert(coordinates::euclidean_pattern_collection<decltype(get_pattern_collection(a23c))>);
  static_assert(coordinates::fixed_pattern_collection<decltype(get_pattern_collection(a23c))>);
  static_assert(collections::index<decltype(get_pattern_collection(a23c))>);

  static_assert(dimension_size_of_index_is<A23, 0, 2>);
  static_assert(not dimension_size_of_index_is<A23, 0, 3, applicability::permitted>);
  static_assert(dimension_size_of_index_is<A23, 1, 3>);
  static_assert(not dimension_size_of_index_is<A23, 1, 2, applicability::permitted>);
  static_assert(dimension_size_of_index_is<A23c, 0, 2>);
  static_assert(not dimension_size_of_index_is<A23c, 0, 3, applicability::permitted>);
  static_assert(dimension_size_of_index_is<A23c, 1, 3>);
  static_assert(not dimension_size_of_index_is<A23c, 1, 2, applicability::permitted>);
...
TEST(arrays, other_object_interface_properties)
{
  static_assert(not interface::nested_object_defined_for<A23>);
  static_assert(stdcompat::same_as<typename interface::get_constant_return_type<A23>::type, std::monostate>);
  static_assert(stdcompat::same_as<typename interface::get_constant_diagonal_return_type<A23>::type, std::monostate>);
  static_assert(not interface::one_dimensional_defined_for<A23>);
  static_assert(not interface::is_square_defined_for<A23>);
  static_assert(not interface::is_triangular_defined_for<A23, triangle_type::any>);
  static_assert(not interface::is_triangular_defined_for<A23, triangle_type::none>);
  static_assert(not interface::is_triangular_adapter_defined_for<A23>);
  static_assert(not interface::is_hermitian_defined_for<A23>);
  static_assert(not interface::hermitian_adapter_type_defined_for<A23>);
}
