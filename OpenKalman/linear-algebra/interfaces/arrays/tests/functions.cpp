...
TEST(arrays, library_interface)
{
  using TraitsA23 = interface::library_interface<A23>;
  using TraitsA23c = interface::library_interface<A23c>;

  // get_component
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N0{}, N0{}}), 1);
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N0{}, N1{}}), 2);
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N0{}, N2{}}), 3);
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N1{}, N0{}}), 4);
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N1{}, N1{}}), 5);
  EXPECT_EQ(TraitsA23::get_component(a23, std::tuple{N1{}, N2{}}), 6);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N0{}, N0{}}), 1);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N0{}, N1{}}), 2);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N0{}, N2{}}), 3);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N1{}, N0{}}), 4);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N1{}, N1{}}), 5);
  EXPECT_EQ(TraitsA23c::get_component(a23c, std::tuple{N1{}, N2{}}), 6);

  // set_component
  A23 b23 {{1, 2, 3}, {4, 5, 6}};
  TraitsA23::set_component(b23, std::tuple{N0{}, N0{}}, 7);
  TraitsA23::set_component(b23, std::tuple{N0{}, N1{}}, 8);
  TraitsA23::set_component(b23, std::tuple{N0{}, N2{}}, 9);
  TraitsA23::set_component(b23, std::tuple{N1{}, N0{}}, 10);
  TraitsA23::set_component(b23, std::tuple{N1{}, N1{}}, 11);
  TraitsA23::set_component(b23, std::tuple{N1{}, N2{}}, 12);
  EXPECT_FALSE(is_near(b23, a23));
  EXPECT_TRUE(is_near(b23, A23 {{7, 8, 9}, {10, 11, 12}}));

  // to_native_matrix
  static_assert(stdcompat::same_as<std::remove_reference_t<decltype(TraitsA23::to_native_matrix(a23))>, A23>);
  static_assert(stdcompat::same_as<std::remove_reference_t<decltype(TraitsA23c::to_native_matrix(a23c))>, A23c>);

}


TEST(arrays, accessors)
{
  // get_component
  EXPECT_EQ(get_component(a23, std::tuple{N0{}, N0{}}), 1);
  EXPECT_EQ(get_component(a23, std::tuple{N0{}, N1{}}), 2);
  EXPECT_EQ(get_component(a23, std::tuple{N0{}, N2{}}), 3);
  EXPECT_EQ(get_component(a23, std::tuple{N1{}, N0{}}), 4);
  EXPECT_EQ(get_component(a23, std::tuple{N1{}, N1{}}), 5);
  EXPECT_EQ(get_component(a23, std::tuple{N1{}, N2{}}), 6);
  EXPECT_EQ(get_component(a23c, std::tuple{N0{}, N0{}}), 1);
  EXPECT_EQ(get_component(a23c, std::tuple{N0{}, N1{}}), 2);
  EXPECT_EQ(get_component(a23c, std::tuple{N0{}, N2{}}), 3);
  EXPECT_EQ(get_component(a23c, std::tuple{N1{}, N0{}}), 4);
  EXPECT_EQ(get_component(a23c, std::tuple{N1{}, N1{}}), 5);
  EXPECT_EQ(get_component(a23c, std::tuple{N1{}, N2{}}), 6);

  // set_component
  A23 b23 {{1, 2, 3}, {4, 5, 6}};
  set_component(b23, std::tuple{N0{}, N0{}}, 7);
  set_component(b23, std::tuple{N0{}, N1{}}, 8);
  set_component(b23, std::tuple{N0{}, N2{}}, 9);
  set_component(b23, std::tuple{N1{}, N0{}}, 10);
  set_component(b23, std::tuple{N1{}, N1{}}, 11);
  set_component(b23, std::tuple{N1{}, N2{}}, 12);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N0{}}), 7);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N1{}}), 8);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N2{}}), 9);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N0{}}), 10);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N1{}}), 11);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N2{}}), 12);

  // to_native_matrix
  EXPECT_TRUE(std::to_address(to_native_matrix(a23)) == std::to_address(a23));
  EXPECT_TRUE(std::to_address(TraitsA23c::to_native_matrix(a23c)) == std::to_address(a23c));

  // assign
  assign(b23, a23);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N0{}}), 1);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N1{}}), 2);
  EXPECT_EQ(get_component(b23, std::tuple{N0{}, N2{}}), 3);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N0{}}), 4);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N1{}}), 5);
  EXPECT_EQ(get_component(b23, std::tuple{N1{}, N2{}}), 6);
}
