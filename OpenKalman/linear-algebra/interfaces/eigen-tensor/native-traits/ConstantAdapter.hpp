 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 constant_adapter
 */

#ifndef OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_CONSTANT_ADAPTER_HPP
#define OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_CONSTANT_ADAPTER_HPP
