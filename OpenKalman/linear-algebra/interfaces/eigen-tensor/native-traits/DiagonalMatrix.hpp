 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref to_diagonal_adapter
 */
...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct native_traits<OpenKalman::to_diagonal_adapter<NestedMatrix>, std::enable_if_t<OpenKalman::Eigen3::eigen_tensor_general<NestedMatrix>>>
#endif
