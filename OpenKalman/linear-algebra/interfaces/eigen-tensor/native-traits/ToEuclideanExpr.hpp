 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref ToEuclideanExpr
 */
...
namespace OpenKalman::Eigen3::internal
{
    ...
    : Eigen::internal::traits<std::decay_t<NestedMatrix>>
  {
    ...
    enum
    {
      Flags = OpenKalman::euclidean_vector_space_descriptor<Coeffs> ? BaseFlags : BaseFlags & ~Eigen::LvalueBit,
    };
  };
...
#endif //OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_TOEUCLIDEANEXPR_HPP
