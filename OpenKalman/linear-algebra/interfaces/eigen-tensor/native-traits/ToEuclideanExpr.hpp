 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref to_stat_space_adapter
 */

#ifndef OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_TOEUCLIDEANEXPR_HPP
#define OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_TOEUCLIDEANEXPR_HPP

namespace OpenKalman::Eigen3::internal
{
#ifdef __cpp_concepts
  template<typename Coeffs, OpenKalman::Eigen3::eigen_tensor_general NestedMatrix>
  struct native_traits<OpenKalman::to_stat_space_adapter<Coeffs, NestedMatrix>>
#else
  template<typename Coeffs, typename NestedMatrix>
  struct native_traits<OpenKalman::to_stat_space_adapter<Coeffs, NestedMatrix>, std::enable_if_t<
