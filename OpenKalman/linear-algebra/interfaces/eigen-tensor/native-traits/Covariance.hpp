 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref Covariance
 */

#ifndef OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_COVARIANCE_HPP
#define OPENKALMAN_EIGEN_TENSOR_NATIVE_TRAITS_COVARIANCE_HPP
...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct native_traits<OpenKalman::Covariance<StaticDescriptor, NestedMatrix>, std::enable_if_t<
    ...
    : Eigen::internal::traits<std::decay_t<std::conditional_t<OpenKalman::hermitian_matrix<NestedMatrix>, NestedMatrix, decltype(cholesky_square(std::declval<NestedMatrix>()))>>>
  {
    ...
    enum
    {
      Flags = Base::Flags & ~(OpenKalman::hermitian_matrix<NestedMatrix> ? 0x0 : Eigen::LvalueBit),
    };
  };
