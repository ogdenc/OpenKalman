 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref from_stat_space_adapter
 */
...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct native_traits<OpenKalman::from_stat_space_adapter<Coeffs, NestedMatrix>>
#else
  template<typename Coeffs, typename NestedMatrix>
  struct native_traits<OpenKalman::from_stat_space_adapter<Coeffs, NestedMatrix>, std::enable_if_t<
