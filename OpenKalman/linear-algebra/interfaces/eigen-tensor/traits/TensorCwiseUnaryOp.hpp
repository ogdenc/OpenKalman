...
namespace OpenKalman::interface
{
  ...
  struct object_traits<Eigen::TensorCwiseUnaryOp<UnaryOp, XprType>>
    : Eigen3::object_traits_tensor_base<Eigen::TensorCwiseUnaryOp<UnaryOp, XprType>>
  {
  private:

    using Xpr = Eigen::TensorCwiseUnaryOp<UnaryOp, XprType>;
    using Base = Eigen3::object_traits_tensor_base<Eigen::TensorCwiseUnaryOp<UnaryOp, XprType>>;
