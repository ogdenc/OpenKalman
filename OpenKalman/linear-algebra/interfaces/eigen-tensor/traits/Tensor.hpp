...
namespace OpenKalman::interface
{
  ...
  struct object_traits<Eigen::Tensor<Scalar, NumIndices, options, IndexType>>
    : Eigen3::object_traits_tensor_base<Eigen::Tensor<Scalar, NumIndices, options, IndexType>>
  {
  private:

    using Base = Eigen3::object_traits_tensor_base<Eigen::Tensor<Scalar, NumIndices, options, IndexType>>;
