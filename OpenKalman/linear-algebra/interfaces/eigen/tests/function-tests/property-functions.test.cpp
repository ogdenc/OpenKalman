...
TEST(eigen3, get_pattern_collection)
{
  ...
  static_assert(patterns::dimension_of_v<decltype(get_pattern_collection<0>(m23))> == 2);
  static_assert(patterns::dimension_of_v<decltype(get_pattern_collection<0>(M2x {m23}))> == 2);
  EXPECT_EQ(get_dimension(get_pattern_collection<0>(Mx3 {m23})), 2);
  EXPECT_EQ(get_dimension(get_pattern_collection<0>(Mxx {m23})), 2);

  static_assert(patterns::dimension_of_v<decltype(get_pattern_collection<1>(m23))> == 3);
  EXPECT_EQ(get_dimension(get_pattern_collection<1>(M2x {m23})), 3);
  static_assert(patterns::dimension_of_v<decltype(get_pattern_collection<1>(Mx3 {m23}))> == 3);
...
{
  static_assert(patterns::dimension_of_v<decltype(std::get<0>(all_vector_space_descriptors(std::declval<M23>())))> == 2);
  static_assert(patterns::dimension_of_v<decltype(std::get<0>(all_vector_space_descriptors<M23>()))> == 2);
  static_assert(patterns::dimension_of_v<decltype(std::get<0>(all_vector_space_descriptors(std::declval<M2x>())))> == 2);
  static_assert(patterns::dimension_of_v<decltype(std::get<1>(all_vector_space_descriptors(std::declval<M23>())))> == 3);
  static_assert(patterns::dimension_of_v<decltype(std::get<1>(all_vector_space_descriptors(std::declval<Mx3>())))> == 3);
