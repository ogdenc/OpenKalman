...
TEST(eigen3, to_diagonal)
{
  ...
  // to_diagonal(M1x {m11}) must create OpenKalman::to_diagonal_adapter. See adapters/tests/to_diagonal_adapter.test.cpp
  // to_diagonal(Mxx {m11}) must create OpenKalman::to_diagonal_adapter. See adapters/tests/to_diagonal_adapter.test.cpp
}
