...
TEST(eigen3, Eigen_Matrix)
{
  ...
  static_assert(index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<2>, Dimensions<2>>>> == 2);
  static_assert(index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<2>, Dimensions<1>>>> == 1);
  static_assert(index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<1>, Dimensions<2>>>> == 2);
  static_assert(index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<1>, Dimensions<1>>>> == 0);
  ...
  static_assert(dynamic_index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<2>, Dimensions<2>>>> == 0);
  static_assert(dynamic_index_count_v<OpenKalman::internal::FixedSizeAdapter<const Mxx, std::tuple<Dimensions<2>, std::size_t>>> == 1);
  ...
  static_assert(compares_with<vector_space_descriptor_of_t<M11, 0>, Axis>);
  static_assert(compares_with<vector_space_descriptor_of_t<M11, 1>, Axis>);
  ...
  static_assert(compares_with<vector_space_descriptor_of_t<M22, 0>, Dimensions<2>);
  static_assert(compares_with<vector_space_descriptor_of_t<M22, 1>, Dimensions<2>>);
  ...
  static_assert(compatible_with_vector_space_descriptor_collection<M23, std::tuple<std::integral_constant<int, 2>, std::integral_constant<int, 3>>>);
  static_assert(not compatible_with_vector_space_descriptor_collection<M23, std::tuple<std::integral_constant<int, 2>, std::integral_constant<int, 2>>>);
  static_assert(compatible_with_vector_space_descriptor_collection<M23, std::tuple<int, int>>);
  static_assert(compatible_with_vector_space_descriptor_collection<M2x, std::tuple<std::integral_constant<int, 2>, std::integral_constant<int, 2>>>);
  static_assert(compatible_with_vector_space_descriptor_collection<M2x, std::tuple<std::integral_constant<int, 2>, int>>);
  static_assert(compatible_with_vector_space_descriptor_collection<M2x, std::tuple<int, int>>);
  static_assert(not compatible_with_vector_space_descriptor_collection<M2x, std::tuple<std::integral_constant<int, 3>, int>>);
  static_assert(compatible_with_vector_space_descriptor_collection<Mx2, std::tuple<std::integral_constant<int, 2>, std::integral_constant<int, 2>>>);
  static_assert(compatible_with_vector_space_descriptor_collection<Mx2, std::tuple<std::integral_constant<int, 2>, int>>);
  static_assert(compatible_with_vector_space_descriptor_collection<Mx2, std::tuple<int, int>>);
  static_assert(not compatible_with_vector_space_descriptor_collection<Mx2, std::tuple<int, std::integral_constant<int, 3>>>);
  static_assert(compatible_with_vector_space_descriptor_collection<Mxx, std::tuple<std::integral_constant<int, 2>, std::integral_constant<int, 2>>>);
  static_assert(compatible_with_vector_space_descriptor_collection<Mxx, std::tuple<int, int>>);
