...
TEST(eigen3, Eigen_TriangularView)
{
  ...
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<C11_2>, Eigen::Lower>> == 2);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z22>, Eigen::Lower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z23>, Eigen::Lower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Zxx>, Eigen::Upper>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z22>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z23>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<decltype(M22::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<decltype(M32::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Cd22_2>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Cd2x_2>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Cdx2_2>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Cdxx_2>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<M11, Eigen::StrictlyLower>> == 0);
  static_assert(constant_value_v<Eigen::TriangularView<M11, Eigen::UnitLower>> == 1);

  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Cd22_2>, Eigen::Lower>> == 2);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z22>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z2x>, Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_matrix<Eigen::TriangularView<Eigen::MatrixWrapper<Z23>, Eigen::StrictlyLower>>);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Z22>, Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Eigen::MatrixWrapper<Zx2>, Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(M22::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(M2x::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(Mx2::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(Mxx::Identity()), Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_matrix<Eigen::TriangularView<decltype(M23::Identity()), Eigen::StrictlyLower>>);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(M22::Identity()), Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(M2x::Identity()), Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(Mx2::Identity()), Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<decltype(Mxx::Identity()), Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_matrix<Eigen::TriangularView<decltype(M23::Identity()), Eigen::UnitUpper>>);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Tlv22, Eigen::UnitUpper>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<Tuv22, Eigen::UnitLower>> == 1);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<M11, Eigen::StrictlyLower>> == 0);
  static_assert(constant_diagonal_value_v<Eigen::TriangularView<M11, Eigen::UnitLower>> == 1);
