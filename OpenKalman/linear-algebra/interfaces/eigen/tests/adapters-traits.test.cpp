...
TEST(eigen3, special_matrix_traits)
{
  ...
  static_assert(not hermitian_adapter_concept<Z22>);
  static_assert(not hermitian_adapter_concept<Z2x>);
  static_assert(not hermitian_adapter_concept<Zx2>);
  static_assert(not hermitian_adapter_concept<Zxx>);
  ...
  static_assert(not hermitian_adapter_concept<C22_2>);
  static_assert(not hermitian_adapter_concept<I22>);
  static_assert(not hermitian_adapter_concept<I2x>);
  static_assert(not hermitian_adapter_concept<Cd22_2>);
  static_assert(not hermitian_adapter_concept<Cd2x_2>);
  static_assert(not hermitian_adapter_concept<Cdx2_2>);
  static_assert(not hermitian_adapter_concept<Cdxx_2>);
  static_assert(not hermitian_adapter_concept<DW21>);
  static_assert(not hermitian_adapter_concept<DW2x>);
  static_assert(not hermitian_adapter_concept<DWx1>);
  static_assert(not hermitian_adapter_concept<DWxx>);

  static_assert(hermitian_adapter_concept<nested_object_of_t<Salv22>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salv2x>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salvx2>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salvxx>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salv2x>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salvx2>, triangle_type::lower>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Salvxx>, triangle_type::lower>);
  static_assert(not hermitian_adapter_concept<nested_object_of_t<Sauv22>, triangle_type::lower>);

  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauv22>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauv2x>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauvx2>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauvxx>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauv2x>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauvx2>, triangle_type::upper>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sauvxx>, triangle_type::upper>);
  static_assert(not hermitian_adapter_concept<nested_object_of_t<Salv22>, triangle_type::upper>);

  static_assert(hermitian_adapter_concept<nested_object_of_t<Sadv22>, triangle_type::any>);
  static_assert(hermitian_adapter_concept<nested_object_of_t<Sadv22>, triangle_type::any>);

  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Salv22>> == triangle_type::lower);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Salv22>, nested_object_of_t<Salv22>> == triangle_type::lower);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Salv2x>, nested_object_of_t<Salvx2>, nested_object_of_t<Salvxx>> == triangle_type::lower);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Sauv22>> == triangle_type::upper);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Sauv22>, nested_object_of_t<Sauv22>> == triangle_type::upper);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Sauv2x>, nested_object_of_t<Sauvx2>, nested_object_of_t<Sauvxx>> == triangle_type::upper);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Sauv22>, nested_object_of_t<Salv22>> == triangle_type::any);
  static_assert(hermitian_adapter_type_of_v<nested_object_of_t<Salv22>, nested_object_of_t<Sauv22>> == triangle_type::any);
}
