...
TEST(eigen3, constant_diagonal_objects)
{
  ...
  static_assert(values::dynamic<constant_diagonal_coefficient<M11>>);
  ...
  static_assert(values::fixed<constant_diagonal_coefficient<Z11>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Z1x>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Z2x>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Zx2>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Zx1>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Zxx>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Z21>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Z12>>);
  static_assert(values::fixed<constant_diagonal_coefficient<Z23>>);
  ...
  static_assert(values::fixed<constant_diagonal_coefficient<C11_1>>);
