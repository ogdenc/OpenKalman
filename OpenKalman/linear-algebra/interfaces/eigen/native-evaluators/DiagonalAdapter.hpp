 ...
 * \internal
 * \file
 * \brief Native Eigen3 evaluator for to_diagonal_adapter
 */
...
namespace Eigen::internal
{
  ...
  struct evaluator<OpenKalman::to_diagonal_adapter<ArgType>>
    : evaluator_base<OpenKalman::to_diagonal_adapter<ArgType>>
  {
    using XprType = OpenKalman::to_diagonal_adapter<ArgType>;
    ...
    auto& coeffRef(Index index)
    {
      static_assert(OpenKalman::one_dimensional<ArgType>,
        "Linear (single index) element access by reference is only available for one-by-one to_diagonal_adapter");
    ...
    {
      static_assert(OpenKalman::one_dimensional<ArgType>,
        "Linear (single index) element access is only available for one-by-one to_diagonal_adapter");
    ...
    {
      static_assert(OpenKalman::one_dimensional<ArgType>,
        "Packet access is only available for one-by-one to_diagonal_adapter");
    ...
    {
      static_assert(OpenKalman::one_dimensional<ArgType>,
        "Linear packet access is only available for one-by-one to_diagonal_adapter");
