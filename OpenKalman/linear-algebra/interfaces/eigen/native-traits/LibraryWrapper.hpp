...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct Strides<Arg, std::enable_if_t<(OpenKalman::layout_of_v<Arg> == OpenKalman::Layout::none)>>
    ...
    static constexpr IndexType stride0 = OpenKalman::value::static_index<Stride0, std::ptrdiff_t> ? static_cast<std::ptrdiff_t>(Stride0{}) : Eigen::Dynamic;
    static constexpr IndexType stride1 = OpenKalman::value::static_index<Stride1, std::ptrdiff_t> ? static_cast<std::ptrdiff_t>(Stride1{}) : Eigen::Dynamic;
