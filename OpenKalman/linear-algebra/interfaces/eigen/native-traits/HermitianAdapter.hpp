 ...
 * \internal
 * \file
 * \brief Native Eigen3 traits for Eigen3 general \ref hermitian_adapter
 */
...
namespace OpenKalman::Eigen3::internal
{
  ...
  template<OpenKalman::Eigen3::eigen_general NestedMatrix, OpenKalman::triangle_type storage_triangle>
