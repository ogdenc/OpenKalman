...
namespace OpenKalman::interface
{
  ...
  public:
      ...
      else
      {
        ...
        if constexpr (dim == dynamic_size)
        {
          return value::static_scalar_operation {
            ...
            value::static_scalar_operation {std::multiplies<scalar_type>{}, constant_coefficient{arg.lhs()}, constant_coefficient{arg.rhs()}}};
        }
        else if constexpr (value::static_scalar<constant_coefficient<LhsType>>)
        {
          return value::static_scalar_operation {
            std::multiplies<scalar_type>{},
            value::static_scalar_operation {std::multiplies<scalar_type>{}, std::integral_constant<std::size_t, dim>{}, constant_coefficient{arg.lhs()}},
            constant_coefficient{arg.rhs()}};
        }
        else
        {
          return value::static_scalar_operation {
            std::multiplies<scalar_type>{},
            value::static_scalar_operation {std::multiplies<scalar_type>{}, std::integral_constant<std::size_t, dim>{}, constant_coefficient{arg.rhs()}},
            constant_coefficient{arg.lhs()}};
        }
      }
    }
    ...
    {
      return value::static_scalar_operation {std::multiplies<scalar_type>{},
    ...
    static constexpr bool is_hermitian =
      (constant_diagonal_matrix<LhsType> and
        (not value::complex_number<scalar_type_of_t<LhsType>> or value::real_scalar<constant_diagonal_coefficient<LhsType>>) and
        hermitian_matrix<RhsType, Qualification::depends_on_dynamic_shape>) or
      (constant_diagonal_matrix<RhsType> and
        (not value::complex_number<scalar_type_of_t<RhsType>> or value::real_scalar<constant_diagonal_coefficient<RhsType>>) and
