...
namespace OpenKalman::Eigen3
{
  ...
  struct BinaryFunctorTraits<std::logical_or<Scalar>>
  {
    ...
    {
      if constexpr (value::static_scalar<constant_coefficient<RhsType>>)
      {
    ...
    {
      if constexpr (value::static_scalar<constant_diagonal_coefficient<RhsType>>)
      {
      ...
      else if constexpr (value::static_scalar<constant_diagonal_coefficient<LhsType>>)
      {
  ...
  struct BinaryFunctorTraits<Eigen::internal::scalar_min_op<Scalar1, Scalar2>>
  {
    ...
    static constexpr auto get_constant(const Arg& arg)
    {
      if constexpr (value::static_scalar<constant_coefficient<LhsType>> and value::static_scalar<constant_diagonal_coefficient<RhsType>>)
      {
      ...
      else if constexpr (value::static_scalar<constant_diagonal_coefficient<LhsType>> and value::static_scalar<constant_coefficient<RhsType>>)
      {
      ...
      {
        return value::static_scalar_operation {constexpr_operation(), constant_coefficient {arg.lhs()}, constant_coefficient {arg.rhs()}};
      }
    }
    ...
    static constexpr auto get_constant_diagonal(const Arg& arg)
    {
      ...
      {
        return value::static_scalar_operation {constexpr_operation(),
