...
namespace OpenKalman::interface
{
  ...
  struct library_interface
  {
    ...
    /**
     * \brief Copy all the elements from another object.
     * \details The other object may be another object within the library or an mdspan.
     * \param other Another compatible \ref indexible object.
     * \note Optional. If omitted, the \ref copy function will perform an element-by-element copy using mdspan.
     */
    ...
    /**
     * \brief Get a slice from a matrix or tensor.
