...
/**
 * \file
 * \brief Definition for \ref coordinate::internal::get_component_start_indices.
 */
...
namespace OpenKalman::coordinate::internal
{
  namespace detail
  {
    ...
    static constexpr auto component_start_indices_tuple(const Tup& tup, CurrLoc currloc = {}, Locs...locs)
    {
      ...
      {
        auto next_loc = value::operation {std::plus{}, currloc, get_descriptor_size(std::get<i>(tup))};
