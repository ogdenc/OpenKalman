...
TEST(coordinates, Spherical_to_stat_space)
{
  ...
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(to_stat_space(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, 2>{}}).get<1>())>, sqrt3_4, 1e-6));
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(to_stat_space(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, 2>{}}).get<2>())>, .75, 1e-6));
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(to_stat_space(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, 2>{}}).get<3>())>, -0.5, 1e-6));
...
TEST(coordinates, Spherical_from_stat_space)
{
  ...
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(from_stat_space(S8{}, std::tuple{values::Fixed<double, 2>{}, values::Fixed<double, 1>{}, values::Fixed<double, -1>{}, values::Fixed<double, -1>{}}).get<1>())>, 315, 1e-6));
...
TEST(coordinates, Spherical_wrap)
{
  ...
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(wrap(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, -2>{}}).get<0>())>, 60., 1e-6));
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(wrap(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, -2>{}}).get<1>())>, 240, 1e-6));
  static_assert(values::internal::near(values::fixed_number_of_v<decltype(wrap(S8{}, std::tuple{values::Fixed<double, -240>{}, values::Fixed<double, 60>{}, values::Fixed<double, -2>{}}).get<2>())>, 2., 1e-6));
