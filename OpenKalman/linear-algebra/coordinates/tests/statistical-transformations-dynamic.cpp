...
TEST(coordinates, combo_axis_angle_dynamic)
{
...
TEST(coordinates, combo_distance_inclination_dynamic)
{
...
TEST(coordinates, combo_polar_dynamic)
{
...
TEST(coordinates, combo_spherical_dynamic)
{
