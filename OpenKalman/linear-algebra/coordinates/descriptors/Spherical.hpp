  ...
  namespace detail
  {
    ...
    public:
      ...
      wrap = [](const T&, auto&& data_view)
      {
        ...
        constexpr auto i_period = values::operation(std::multiplies{}, values::cast_to<R>(Down{}), values::Fixed<R, 2>{});
  ...
  struct common_type<
    ...
    : std::conditional<
      OpenKalman::values::fixed_number_of_v<Min1> == OpenKalman::values::fixed_number_of_v<Min2> and
          OpenKalman::values::fixed_number_of_v<Max1> == OpenKalman::values::fixed_number_of_v<Max2> and
