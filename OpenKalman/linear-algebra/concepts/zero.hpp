...
namespace OpenKalman
{
  ...
  namespace detail
  {
    ...
    template<typename T>
    struct is_zero<T, std::enable_if_t<value::static_scalar<constant_coefficient<T>>>>
  ...
  concept zero =
    value::static_scalar<constant_coefficient<T>> and internal::are_within_tolerance(constant_coefficient_v<T>, 0);
#else
