...
{
  auto a = make_dense_object_from<M23>(1, 2, 3, 4, 5, 6);
  EXPECT_TRUE(is_near(attach_patterns<C2, C3>(a), a));
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2, C3, 0>(a))>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2, C3>(a)), 1>, C3>);
  EXPECT_TRUE(is_near(attach_patterns<C2>(a), a));
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2, 0>(a))>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2>(a)), 1>, Dimensions<3>>);

  auto b = Mat23 {1, 2, 3, 4, 5, 6};
  EXPECT_TRUE(is_near(attach_patterns(b), a));
  ...
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2, C3, M23>()), 0>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<C2, C3, M23>()), 1>, C3>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<M23>()), 0>, Dimensions<2>>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(attach_patterns<M23>()), 1>, Dimensions<3>>);
}
...
TEST(adapters, VectorSpaceDescriptor_overloads)
{
  ...
  EXPECT_TRUE(is_near(conjugate_transpose(Mat23 {1, 2, 3, 4, 5, 6}).nested_object(), Mat32 {1, 4, 2, 5, 3, 6}));
...
TEST(adapters, VectorSpaceDescriptor_blocks)
{
  ...
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(apply_columnwise<2>(std::declval<VectorSpaceDescriptor<C2, angle::Radians>()>())), 0>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(apply_columnwise<2>(std::declval<VectorSpaceDescriptor<C2, angle::Radians>()>())), 1>, std::tuple<angle::Radians, angle::Radians>>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(apply_columnwise<2>(std::declval<VectorSpaceDescriptor<C2, angle::Radians>(std::size_t)>())), 0>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(apply_columnwise<2>(std::declval<VectorSpaceDescriptor<C2, angle::Radians>(std::size_t)>())), 1>, std::array<angle::Radians, 2>>);
...
TEST(adapters, VectorSpaceDescriptor_arithmetic)
{
  ...
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(VectorSpaceDescriptor<C2, Dimensions<2>, M22> {1, 2, 3, 4} * EuclideanMean<Dimensions<2>, M23> {1, 2, 3, 4, 5, 6}), 0>, C2>);
  static_assert(compares_with<vector_space_descriptor_of_t<decltype(VectorSpaceDescriptor<C2, Dimensions<2>, M22> {1, 2, 3, 4} * EuclideanMean<Dimensions<2>, M23> {1, 2, 3, 4, 5, 6}), 1>, Dimensions<3>>);
