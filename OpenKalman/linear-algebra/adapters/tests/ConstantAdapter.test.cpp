...
TEST(adapters, ConstantAdapter_traits)
{
  ...
  static_assert(values::fixed<constant_coefficient<ConstantAdapter<M22, double, 1>>>);
  static_assert(not values::dynamic<constant_coefficient<ConstantAdapter<M22, double, 1>>>);
  static_assert(values::dynamic<constant_coefficient<ConstantAdapter<M22>>>);
  static_assert(not values::fixed<constant_coefficient<ConstantAdapter<M22>>>);
...
TEST(adapters, make_constant)
{
  ...
  constexpr values::Fixed<double, 5> nd5;
  ...
  static_assert(constant_coefficient_v<decltype(make_constant<C534>(values::Fixed<double, 5>{}, Dimensions<2>(), Dimensions<3>()))> == 5);
  static_assert(constant_coefficient_v<decltype(make_constant<C534>(values::Fixed<double, 5>{}, Dimensions<2>(), 3))> == 5);
  static_assert(constant_coefficient_v<decltype(make_constant<C534>(values::Fixed<double, 5>{}, 2, Dimensions<3>()))> == 5);
  static_assert(constant_coefficient_v<decltype(make_constant<C534>(values::Fixed<double, 5>{}, 2, 3))> == 5);
...
TEST(adapters, ConstantAdapter_arithmetic)
{
  ...
  static_assert(values::fixed<constant_coefficient<decltype(ConstantAdapter<M22, double, 0> {} * 2.0)>>);
  static_assert(values::dynamic<constant_coefficient<decltype(ConstantAdapter<M22, double, 3> {} * 2.0)>>);
  static_assert(values::fixed<constant_coefficient<decltype(ConstantAdapter<M22, double, 3> {} * N2{})>>);
  ...
  static_assert(values::fixed<constant_coefficient<decltype(3.0 * ConstantAdapter<M22, double, 0> {})>>);
  static_assert(values::dynamic<constant_coefficient<decltype(3.0 * ConstantAdapter<M22, double, 2> {})>>);
  static_assert(values::fixed<constant_coefficient<decltype(N2{} * ConstantAdapter<M22, double, 2> {})>>);
  ...
  static_assert(values::fixed<constant_coefficient<decltype(ConstantAdapter<M22, double, 3> {} + ConstantAdapter<M22, double, 5> {})>>);
  static_assert(not constant_adapter<decltype(ConstantAdapter<M22, double, 3> {} + ConstantAdapter<M22, double, 5> {})>);
  static_assert(values::dynamic<constant_coefficient<decltype(M22::Constant(5) + ConstantAdapter<M22, double, 3> {})>>);
  ...
  static_assert(values::fixed<constant_coefficient<decltype(ConstantAdapter<M23, double, 3> {} * ConstantAdapter<M32, double, 5> {})>>);
  static_assert(not constant_adapter<decltype(ConstantAdapter<M23, double, 3> {} * ConstantAdapter<M32, double, 5> {})>);
  static_assert(values::dynamic<constant_coefficient<decltype(M23::Constant(3) * ConstantAdapter<M32, double, 5> {})>>);
