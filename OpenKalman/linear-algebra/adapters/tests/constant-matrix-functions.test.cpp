...
TEST(adapters, constant_solve)
{
  ...
  static_assert(value::dynamic_scalar<constant_coefficient<decltype(solve(c2x_2, c23))>>);
  static_assert(constant_coefficient_v<decltype(solve(cx2_2, c23))> == 2);
  static_assert(value::dynamic_scalar<constant_coefficient<decltype(solve(cxx_22, c23))>>);
