...
#define MINIMUMNORMALCLANGVERSION 1000 // Set this to a permanent value after clang doesn't cause an issue. Is at least 19.
...
#define FUNCTIONISCONSTEXPRCALLABLE(F)                                                                       \
  ...
  {                                                                                                          \
    ...
    {                                                                                                        \
      ...
      {                                                                                                      \
        if constexpr (value::complex_number<Arg>) return std::tuple {false, Arg{}};                                 \
        else                                                                                                 \
        {                                                                                                    \
...
#define FUNCTIONISCONSTEXPRCALLABLE2(F)                                                                      \
  ...
  {                                                                                                          \
    ...
    {                                                                                                        \
      ...
      {                                                                                                      \
        if constexpr (value::complex_number<Arg1>) return std::tuple {false, Arg1{}};                               \
        else if constexpr (value::complex_number<Arg2>) return std::tuple {false, Arg2{}};                          \
        else                                                                                                 \
        {                                                                                                    \
...
namespace OpenKalman::internal
{
  ...
  namespace detail
  {
    ...
    constexpr decltype(auto) convert_to_floating(T&& x)
    {
      ...
      if constexpr (value::complex_number<T>)
      {
    ...
    // Convert a scalar type to an output type
  ...
  namespace detail
  {
    ...
    template<typename Arg>
    struct real_trait_exists<Arg, std::void_t<decltype(interface::number_traits<Arg>::real(std::declval<const Arg&>()))>>
      : std::true_type {};
  }
#endif
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_real(value::scalar auto&& arg)
#else
...
#endif
  {
    ...
    if constexpr (not value::number<Arg>)
    {
      struct Op
      {
        using A = std::decay_t<decltype(value::to_number(arg))>;
        constexpr auto operator()(const A& a) const { return constexpr_real(a); }
      };
      return value::static_scalar_operation {Op{}, std::forward<Arg>(arg)};
    }
    else if constexpr (value::complex_number<Arg>)
    {
  ...
  #ifdef __cpp_concepts
      if constexpr (requires(const Arg_t& a) { interface::number_traits<Scalar>::real(a); })
  #else
      if constexpr (detail::real_trait_exists<Arg_t>::value)
  #endif
        return static_cast<Scalar>(interface::number_traits<Arg_t>::real(std::forward<Arg>(arg)));
      else
      {
        using std::real;
  ...
  namespace detail
  {
    ...
    template<typename Arg>
    struct imag_trait_exists<Arg, std::void_t<decltype(interface::number_traits<Arg>::imag(std::declval<const Arg&>()))>>
      : std::true_type {};
  }
#endif
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_imag(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
  ...
  #ifdef __cpp_concepts
      if constexpr (requires(const Arg_t& a) { interface::number_traits<Scalar>::imag(a); })
  #else
      if constexpr (detail::imag_trait_exists<Arg_t>::value)
  #endif
        return static_cast<Scalar>(interface::number_traits<Arg_t>::imag(std::forward<Arg>(arg)));
      else
      {
        using std::imag;
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_conj(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#endif
  {
    ...
    else
    {
      ...
      {
        static_assert(not value::complex_number<Arg>);
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_signbit(value::scalar auto&& arg) requires (not value::complex_number<decltype(value::to_number(arg))>)
#else
  template <typename T, std::enable_if_t<value::scalar<T> and not value::complex_number<decltype(value::to_number(std::declval<T>()))>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  template<value::scalar Mag, value::scalar Sgn> requires
    (not value::complex_number<decltype(value::to_number(std::declval<Mag>()))>) and
    (not value::complex_number<decltype(value::to_number(std::declval<Sgn>()))>) and
    (std::same_as<std::decay_t<decltype(value::to_number(std::declval<Mag>()))>, std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>> or
      (std::numeric_limits<std::decay_t<decltype(value::to_number(std::declval<Mag>()))>>::is_integer and
        std::numeric_limits<std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>>::is_integer))
#else
  template <typename Mag, typename Sgn, std::enable_if_t<value::scalar<Mag> and value::scalar<Sgn> and
    not value::complex_number<decltype(value::to_number(std::declval<Sgn>()))> and not value::complex_number<decltype(value::to_number(std::declval<Sgn>()))> and
    (std::is_same_v<std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>, std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>> or
      (std::numeric_limits<std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>>::is_integer and
        std::numeric_limits<std::decay_t<decltype(value::to_number(std::declval<Sgn>()))>>::is_integer)), int> = 0>
#endif
  constexpr auto constexpr_copysign(Mag&& mag, Sgn&& sgn)
  {
    if constexpr (not value::number<Mag> or not value::number<Sgn>)
    {
      struct Op
      {
        using M = std::decay_t<decltype(value::to_number(mag))>;
        using S = std::decay_t<decltype(value::to_number(sgn))>;
        constexpr auto operator()(const M& m, const S& s) const { return constexpr_copysign(m, s); }
      };
      return value::static_scalar_operation {Op{}, std::forward<Mag>(mag), std::forward<Sgn>(sgn)};
    }
    else
    {
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_sqrt(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_abs(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#endif
  {
    ...
    else
    {
      ...
      {
        if (is_callable) return ret;
        else if constexpr (value::complex_number<decltype(arg)>)
        {
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_exp(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_expm1(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_sinh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#endif
  {
    ...
    else
    {
      ...
      if constexpr (not value::complex_number<Scalar> and std::numeric_limits<Scalar>::has_infinity)
      {
        if (x == std::numeric_limits<Scalar>::infinity()) return constexpr_infinity<Scalar>();
...
#if __cpp_lib_constexpr_complex >= 201711L and (not defined(__clang__) or __clang_major__ >= MINIMUMNORMALCLANGVERSION)
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_cosh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_tanh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_sin(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_cos(value::scalar auto&& arg)
#else
  template <typename T>
  constexpr auto constexpr_cos(T&& arg, std::enable_if_t<value::scalar<T>, int> = 0)
#endif
  {
    using Arg = decltype(arg);
...
#ifdef __cpp_concepts
  constexpr auto constexpr_tan(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_log(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
   ...
   */
#ifdef __cpp_concepts
  constexpr auto constexpr_log1p(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_asinh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_acosh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_atanh(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_asin(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_acos(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  constexpr auto constexpr_atan(value::scalar auto&& arg)
#else
  template <typename T, std::enable_if_t<value::scalar<T>, int> = 0>
...
#ifdef __cpp_concepts
  template <value::scalar Y, value::scalar X>
#else
  template <typename Y, typename X, std::enable_if_t<value::scalar<Y> and value::scalar<X>, int> = 0>
#endif
  constexpr auto constexpr_atan2(Y&& y_arg, X&& x_arg)
  {
    if constexpr (not value::number<Y> or not value::number<X>)
    {
      struct Op
      {
        using YA = std::decay_t<decltype(value::to_number(y_arg))>;
        using XA = std::decay_t<decltype(value::to_number(x_arg))>;
        constexpr auto operator()(const YA& y, const XA& x) const { return constexpr_atan2(y, x); }
      };
      return value::static_scalar_operation {Op{}, std::forward<Y>(y_arg), std::forward<X>(x_arg)};
    }
    else
    {
      ...
      if constexpr (value::complex_number<Y> or value::complex_number<X>)
      {
  ...
  namespace detail
  {
    ...
    {
      using R = std::conditional_t<value::complex_number<T>, std::decay_t<decltype(constexpr_real(x))>, T>;
   ...
   */
#ifdef __cpp_concepts
  template<value::scalar Arg, value::scalar Exponent>
#else
  template <typename Arg, typename Exponent, std::enable_if_t<value::scalar<Arg> and value::scalar<Exponent>, int> = 0>
#endif
  constexpr auto constexpr_pow(Arg&& arg, Exponent&& exponent)
  {
    if constexpr (not value::number<Arg> or not value::number<Exponent>)
    {
      ...
      {
        using A = std::decay_t<decltype(value::to_number(arg))>;
        using E = std::decay_t<decltype(value::to_number(exponent))>;
        constexpr auto operator()(const A& a, const E& e) const { return constexpr_pow(a, e); }
      };
      return value::static_scalar_operation {Op{}, std::forward<Arg>(arg), std::forward<Exponent>(exponent)};
    }
    else
    {
