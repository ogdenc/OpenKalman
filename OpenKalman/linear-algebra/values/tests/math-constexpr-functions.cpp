...
#include "linear-algebra/values/functions/conj.hpp"
...
#include "linear-algebra/values/functions/expm1.hpp"
...
#include "linear-algebra/values/functions/tanh.hpp"
...
#include "linear-algebra/values/functions/tan.hpp"
...
#include "linear-algebra/values/functions/log1p.hpp"
...
#include "linear-algebra/values/functions/asinh.hpp"
...
#include "linear-algebra/values/functions/acosh.hpp"
...
#include "linear-algebra/values/functions/atanh.hpp"
...
#include "linear-algebra/values/functions/acos.hpp"
...
#include "linear-algebra/values/functions/atan.hpp"
...
#include "linear-algebra/values/functions/pow.hpp"
...
TEST(values, pow)
{
  if constexpr (std::numeric_limits<double>::is_iec559)
  {
    ...
    EXPECT_TRUE(value::pow(value::internal::infinity<double>(), -3.) == 0);
#ifndef __clang__ // This is not fixed for at least clang version 19.
    EXPECT_TRUE(std::signbit(value::pow(-value::internal::infinity<double>(), -3.)));
