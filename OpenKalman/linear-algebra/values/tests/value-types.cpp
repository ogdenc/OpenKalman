...
TEST(values, Fixed)
{
  ...
  static_assert(std::is_same_v<value::real_type_of_t<value::Fixed<double, 3>>, value::Fixed<double, 3>>);
}

#include "linear-algebra/values/functions/value-arithmetic.hpp"
...
#include "linear-algebra/values/functions/cast_to.hpp"
