...
namespace OpenKalman
{
  ...
  namespace detail
  {
    ...
    struct equivalent_to_uniform_static_vector_space_descriptor_component_of_impl<T, C, std::enable_if_t<
      equivalent_to<T, typename uniform_static_vector_space_descriptor_component_of<C>::type>>> : std::true_type {};
  }
#endif
  ...
  concept equivalent_to_uniform_static_vector_space_descriptor_component_of = equivalent_to<T, uniform_static_vector_space_descriptor_component_of_t<C>>;
#else
