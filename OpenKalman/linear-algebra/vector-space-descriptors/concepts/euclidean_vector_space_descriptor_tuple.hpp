...
/**
 * \file
 * \brief Definition for \ref euclidean_vector_space_descriptor_tuple.
 */

#ifndef OPENKALMAN_EUCLIDEAN_VECTOR_SPACE_DESCRIPTOR_TUPLE_HPP
#define OPENKALMAN_EUCLIDEAN_VECTOR_SPACE_DESCRIPTOR_TUPLE_HPP
...
namespace OpenKalman::descriptor
{
  ...
  namespace detail
  {
    ...
    constexpr bool is_euclidean_descriptor_tuple_impl(std::index_sequence<Ix...>)
    {
...
#else
  constexpr bool euclidean_vector_space_descriptor_tuple =
    detail::is_euclidean_descriptor_tuple<std::decay_t<T>>::value;
#endif
