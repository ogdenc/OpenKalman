...
#else
  template<typename T>
  struct euclidean_dimension_size_of<T, std::enable_if_t<descriptor::dynamic_vector_space_descriptor<T>>>
#endif
...
#else
  template<typename T>
  struct euclidean_dimension_size_of<T, std::enable_if_t<descriptor::static_vector_space_descriptor<T>>>
#endif
