...
/**
 * \file
 * \brief Definition for \ref descriptor::internal::get_euclidean_component_start_indices.
 */

#ifndef OPENKALMAN_DESCRIPTORS_GET_EUCLIDEAN_COMPONENT_INDEX_HPP
#define OPENKALMAN_DESCRIPTORS_GET_EUCLIDEAN_COMPONENT_INDEX_HPP
...
namespace OpenKalman::descriptor::internal
{
  ...
  get_euclidean_component_start_indices(Arg&& arg)
  {
    ...
    {
      auto ret = interface::coordinate_set_traits<std::decay_t<Arg>>::euclidean_component_start_indices(std::forward<Arg>(arg));
...
#endif //OPENKALMAN_DESCRIPTORS_GET_EUCLIDEAN_COMPONENT_INDEX_HPP
