...
{
  using namespace descriptor::internal;
  ...
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<std::integral_constant<int, -180>, std::integral_constant<int, 180>>{}))>, angle::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<std::integral_constant<long long int, -180>, std::integral_constant<std::size_t, 180>>{}))>, angle::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<value::Fixed<long double, -180>, value::Fixed<double, 180>>{}))>, angle::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<std::integral_constant<std::size_t, 0>, std::integral_constant<std::size_t, 360>>{}))>, angle::PositiveDegrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<std::integral_constant<std::size_t, 0>, std::integral_constant<int, 360>>{}))>, angle::PositiveDegrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Angle<value::fixed_minus_pi<double>, value::fixed_pi<float>>{}))>, angle::Radians>);

  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Inclination<std::integral_constant<int, -90>, std::integral_constant<int, 90>>{}))>, inclination::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Inclination<std::integral_constant<long long int, -90>, std::integral_constant<std::size_t, 90>>{}))>, inclination::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Inclination<value::Fixed<long double, -90>, value::Fixed<double, 90>>{}))>, inclination::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(Inclination<value::fixed_minus_half_pi<double>, value::fixed_half_pi<float>>{}))>, inclination::Radians>);
  ...
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<StaticDescriptor<>, angle::Degrees>{}))>, angle::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<StaticDescriptor<>, angle::Degrees, StaticDescriptor<>>{}))>, angle::Degrees>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<Axis, angle::Degrees>{}))>, StaticDescriptor<Axis, angle::Degrees>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<StaticDescriptor<Axis>, angle::Degrees>{}))>, StaticDescriptor<Axis, angle::Degrees>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<Dimensions<3>, angle::Degrees>{}))>, StaticDescriptor<Dimensions<3>, angle::Degrees>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<angle::Degrees, Dimensions<3>>{}))>, StaticDescriptor<angle::Degrees, Dimensions<3>>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<angle::Degrees, Dimensions<3>, angle::Degrees>{}))>, StaticDescriptor<angle::Degrees, Dimensions<3>, angle::Degrees>>);
  static_assert(not std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<Axis, angle::Degrees, angle::Degrees, Distance>{}))>, StaticDescriptor<Axis, angle::Degrees, Axis>>);
  static_assert(not std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<Axis, angle::Degrees>{}))>, StaticDescriptor<Polar<Distance, angle::Degrees>>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<Dimensions<1>, Dimensions<2>, angle::Degrees>{}))>, StaticDescriptor<Dimensions<3>, angle::Degrees>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<StaticDescriptor<Dimensions<1>, Dimensions<2>>, angle::Degrees>{}))>, StaticDescriptor<Dimensions<3>, angle::Degrees>>);
  static_assert(std::is_same_v<std::decay_t<decltype(canonical_equivalent(StaticDescriptor<angle::Degrees, Dimensions<1>, Dimensions<2>>{}))>, StaticDescriptor<angle::Degrees, Dimensions<3>>>);
}
...
TEST(descriptors, dynamic_comparison)
{
  ...
  EXPECT_TRUE((DynamicDescriptor<double> {angle::Degrees {}} == DynamicDescriptor<double> {Angle<std::integral_constant<int, -180>, std::integral_constant<int, 180>> {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {angle::Degrees {}} == DynamicDescriptor<double> {Angle<value::Fixed<double, -180>, value::Fixed<long double, 180>> {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {angle::PositiveDegrees {}} == DynamicDescriptor<double> {Angle<std::integral_constant<int, 0>, std::integral_constant<std::size_t, 360>> {}}));
  ...
  EXPECT_TRUE((DynamicDescriptor<double> {StaticDescriptor<> {}} < DynamicDescriptor<double> {inclination::Radians {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {inclination::Radians {}} > DynamicDescriptor<double> {StaticDescriptor<> {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {inclination::Radians {}} == DynamicDescriptor<double> {inclination::Radians {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {inclination::Degrees {}} == DynamicDescriptor<double> {Inclination<std::integral_constant<int, -90>, std::integral_constant<int, 90>> {}}));
  EXPECT_TRUE((DynamicDescriptor<double> {inclination::Degrees {}} == DynamicDescriptor<double> {Inclination<value::Fixed<double, -90>, value::Fixed<long double, 90>> {}}));
