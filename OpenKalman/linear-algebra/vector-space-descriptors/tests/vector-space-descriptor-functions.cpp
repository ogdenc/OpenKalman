...
{
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Axis{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}}, g(pi/3), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}}, g(pi/3), 1, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Degrees{}}, g(60.), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Degrees{}}, g(30.), 1, 0)), 0.5, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis>{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Axis>{}}, g(3., 2.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Axis>{}}, g(3., 2.), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Axis{}, DynamicDescriptor<double> {Axis{}}}, g(3., 2.), 1, 0)), 2., 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Degrees>{}}, g(-60.), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Degrees>{}}, g(-30.), 1, 0)), -0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, angle::PositiveRadians>{}}, g(pi / 3, pi / 6), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, angle::PositiveRadians>{}}, g(pi / 3, pi / 6), 1, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, angle::Radians>{}}, g(pi / 3, pi / 6), 2, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, angle::Radians>{}}, g(pi / 3, pi / 6), 3, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {DynamicDescriptor<double> {angle::Radians{}}, angle::Radians{}}, g(pi / 3, pi / 6), 3, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}, DynamicDescriptor<double> {angle::Radians{}}}, g(pi / 3, pi / 6), 3, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}, Dimensions<2>{}, DynamicDescriptor<double> {angle::Radians{}}}, g(pi / 3, 3., 4., pi / 6), 5, 0)), 0.5, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3., pi / 3), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3., pi / 3), 1, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3., pi / 3), 2, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Axis{}, angle::Radians{}}, g(3., pi / 3), 2, 0)), std::sqrt(3) / 2, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g<float>(3., pi / 3), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3., pi / 3), 0, 0)), 3., 1e-6);
...
{
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Distance{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Distance{}}, g(-3.), 0, 0)), -3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}}, g(pi/3), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Radians{}}, g(pi/3), 1, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {angle::Degrees{}}, g(60.), 0, 0)), 0.5, 1e-6);
  ...
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance>{}}, g(-3.), 0, 0)), -3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, Distance>{}}, g(3., -2.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, Distance>{}}, g(3., -2.), 1, 0)), -2., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Distance{}, DynamicDescriptor<double>{Distance{}}}, g(3., -2.), 1, 0)), -2., 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees>{}}, g(-60.), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees>{}}, g(-30.), 1, 0)), -0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Radians>{}}, g(pi / 3, pi / 6), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Radians>{}}, g(pi / 3, pi / 6), 1, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Radians>{}}, g(pi / 3, pi / 6), 2, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Radians>{}}, g(pi / 3, pi / 6), 3, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {DynamicDescriptor<double>{inclination::Radians{}}, inclination::Radians{}}, g(pi / 3, pi / 6), 3, 0)), 0.5, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3., pi / 3), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3., pi / 3), 1, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3., pi / 3), 2, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Distance{}, DynamicDescriptor<double>{inclination::Radians{}, Distance{}}}, g(3., pi / 3, 4), 2, 0)), std::sqrt(3) / 2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Distance{}, DynamicDescriptor<double>{inclination::Radians{}, Distance{}}}, g(3., pi / 3, 4), 3, 0)), 4, 1e-6);
...
{
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Radians>{}}, g(3., pi/3), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Radians>{}}, g(3., pi/3), 1, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Radians>{}}, g(3., pi/3), 2, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<angle::Radians, Distance>{}}, g(pi/3, 3.), 0, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<angle::Radians, Distance>{}}, g(pi/3, 3.), 1, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<angle::Radians, Distance>{}}, g(pi/3, 3.), 2, 0)), 3., 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Degrees>{}}, g(3., 60.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Degrees>{}}, g(3., 60.), 1, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Polar<Distance, angle::Degrees>{}}, g(3., 60.), 2, 0)), std::sqrt(3)/2, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Degrees>>{}}, g(1.1, 3., 60.), 0, 0)), 1.1, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Degrees>>{}}, g(1.1, 3., 60.), 1, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Degrees>>{}}, g(1.1, 3., 60.), 2, 0)), 0.5, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Degrees>>{}}, g(1.1, 3., 60.), 3, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Axis{}, DynamicDescriptor<double>{Polar<Distance, angle::Degrees>{}}}, g(1.1, 3., 60.), 3, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {DynamicDescriptor<double>{Axis{}}, Polar<Distance, angle::Degrees>{}}, g(1.1, 3., 60.), 3, 0)), std::sqrt(3)/2, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Degrees>>{}}, g<long double>(1.1, 3., 60.), 0, 0)), 1.1, 1e-6);
...
{
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., pi/6, pi/3), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., pi/6, pi/3), 1, 0)), std::sqrt(3)/4, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., pi/6, pi/3), 2, 0)), 0.25, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., pi/6, pi/3), 3, 0)), std::sqrt(3)/2, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., pi/6, pi/3), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., pi/6, pi/3), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., pi/6, pi/3), 2, 0)), std::sqrt(3)/4, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., pi/6, pi/3), 3, 0)), 0.25, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., pi/6, pi/3), 4, 0)), std::sqrt(3)/2, 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., pi/6, pi/3, 3.), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., pi/6, pi/3, 3.), 1, 0)), std::sqrt(3)/4, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., pi/6, pi/3, 3.), 2, 0)), 0.25, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., pi/6, pi/3, 3.), 3, 0)), std::sqrt(3)/2, 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., pi/6, pi/3, 3.), 4, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {DynamicDescriptor<double>{Spherical<Distance, angle::Radians, inclination::Radians>{}}, Axis{}}, g(2., pi/6, pi/3, 3.), 4, 0)), 3., 1e-6);
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}, DynamicDescriptor<double>{Axis{}}}, g(2., pi/6, pi/3, 3.), 4, 0)), 3., 1e-6);

  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g<float>(2., pi/6, pi/3, 3.), 0, 0)), 2., 1e-6);
  ...
  EXPECT_NEAR((to_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g<long double>(2., pi/6, pi/3, 3.), 4, 0)), 3., 1e-6);
}
...
{
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis>{}}, g(3.), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis>{}}, g(-3.), 0, 0)), -3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians>{}}, g(0.5, std::sqrt(3) / 2), 0, 0)), pi / 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Degrees>{}}, g(0.5, std::sqrt(3) / 2), 0, 0)), 60, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3, 0.5, -std::sqrt(3) / 2), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3, 0.5, -std::sqrt(3) / 2), 1, 0)), -pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, Axis>{}}, g(0.5, std::sqrt(3) / 2, 3), 0, 0)), pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, Axis>{}}, g(0.5, std::sqrt(3) / 2, 3), 1, 0)), 3, 1e-6);

  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g<float>(3, 0.5, -std::sqrt(3) / 2), 0, 0)), 3, 1e-6);
...
{
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance>{}}, g(3.), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance>{}}, g(-3.), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians>{}}, g(0.5, std::sqrt(3) / 2), 0, 0)), pi / 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees>{}}, g(0.5, std::sqrt(3) / 2), 0, 0)), 60, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3, 0.5, -std::sqrt(3) / 2), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3, 0.5, -std::sqrt(3) / 2), 1, 0)), -pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, Distance>{}}, g(0.5, std::sqrt(3) / 2, 3), 0, 0)), pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, Distance>{}}, g(0.5, std::sqrt(3) / 2, 3), 1, 0)), 3, 1e-6);
...
{
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>>{}}, g(3., 0.5, std::sqrt(3) / 2), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>>{}}, g(3., 0.5, std::sqrt(3) / 2), 1, 0)), pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(1.1, 3, 0.5, -std::sqrt(3) / 2), 0, 0)), 1.1, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(1.1, 3, 0.5, -std::sqrt(3) / 2), 1, 0)), 3., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(1.1, 3, 0.5, -std::sqrt(3) / 2), 2, 0)), -pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(0.5, std::sqrt(3)/2, 3, 1.1), 0, 0)), 60, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(0.5, std::sqrt(3)/2, 3, 1.1), 1, 0)), 3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(0.5, std::sqrt(3)/2, 3, 1.1), 2, 0)), 1.1, 1e-6);

  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g<long double>(0.5, std::sqrt(3)/2, 3, 1.1), 0, 0)), 60, 1e-6);
...
{
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 1, 0)), pi/6, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 2, 0)), pi/3, 1e-6);

  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 2, 0)), pi/6, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., 2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2), 3, 0)), pi/3, 1e-6);

  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 1, 0)), pi/6, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 2, 0)), pi/3, 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 3, 0)), 3., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {DynamicDescriptor<double>{Spherical<Distance, angle::Radians, inclination::Radians>{}}, Axis{}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 3, 0)), 3., 1e-6);
  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}, DynamicDescriptor<double>{Axis{}}}, g(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 3, 0)), 3., 1e-6);

  EXPECT_NEAR((from_euclidean_element(DynamicDescriptor<double> {StaticDescriptor<Spherical<Distance, angle::Radians, inclination::Radians>, Axis>{}}, g<float>(2., std::sqrt(3)/4, 0.25, std::sqrt(3)/2, 3.), 0, 0)), 2., 1e-6);
...
{
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis>{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis>{}}, g(-3.), 0, 0)), -3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians>{}}, g(1.2*pi), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::PositiveRadians>{}}, g(-0.2*pi), 0, 0)), 1.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Degrees>{}}, g(200.), 0, 0)), -160., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::PositiveDegrees>{}}, g(-20.), 0, 0)), 340., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Circle>{}}, g(-0.2), 0, 0)), 0.8, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3, 1.2*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, angle::Radians>{}}, g(3, 1.2*pi), 1, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, Axis>{}}, g(1.2*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, Axis>{}}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, StaticDescriptor<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, StaticDescriptor<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 1, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, StaticDescriptor<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 2, 0)), -0.7*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, StaticDescriptor<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 3, 0)), 3, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<angle::Radians, StaticDescriptor<Axis, angle::Radians>, Axis>{}}, g<double>(1.2*pi, 5, 1.3*pi, 3), 0, 0)), -0.8*pi, 1e-6);
...
{
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance>{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance>{}}, g(-3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians>{}}, g(0.7*pi), 0, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians>{}}, g(1.2*pi), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees>{}}, g(110.), 0, 0)), 70., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees>{}}, g(200.), 0, 0)), -20., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3, 0.7*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g(3, 0.7*pi), 1, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, Distance>{}}, g(1.2*pi, 3), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, Distance>{}}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance, inclination::Radians>{}}, g<long double>(3, 0.7*pi), 0, 0)), 3, 1e-6);
...
{
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(3., 2., 1.1*pi), 2, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 2, 0)), 0.1*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., 2., 4.), 0, 0)), -170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., 4.), 0, 0)), 10, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., 4.), 1, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, 4.), 0, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(2., -0.1*pi, 4.), 1, 0)), 1.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, 4.), 1, 0)), 0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., 2.), 0, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., 2.), 1, 0)), 350, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., -2.), 1, 0)), 170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., -2.), 2, 0)), 2, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g<float>(5., -10., 2.), 0, 0)), 5, 1e-6);
...
{
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 0.5*pi, 0.6*pi), 1, 0)), -0.5*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 0.5*pi, 0.6*pi), 2, 0)), 0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 0.5*pi, 0.6*pi), 1, 0)), 0.5*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 0.5*pi, 0.6*pi), 2, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 1, 0)), 0.1*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 2, 0)), 0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 1.1*pi, 0.6*pi), 1, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 1.1*pi, 0.6*pi), 2, 0)), -0.4*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {DynamicDescriptor<double>{Axis{}}, Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Axis{}, DynamicDescriptor<double>{Spherical<Distance, angle::Radians, inclination::Radians>{}}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicDescriptor<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g<float>(2., 1.1*pi, 0.6*pi), 1, 0)), 0.1*pi, 1e-6);
...
TEST(basics, set_wrapped_component_distance_inclination)
{
  ...
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance, Distance>{}}, s, g, 2.1, 0, 0);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Distance, Distance>{}}, s, g, -2.1, 1, 0);
  EXPECT_NEAR(a1[0], 2.1, 1e-6);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Degrees>{}}, s, g, 0.7*pi, 0, 0);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Radians, inclination::Degrees>{}}, s, g, 110., 1, 0);
  EXPECT_NEAR(a1[0], 0.3*pi, 1e-6);
  EXPECT_NEAR(a1[1], 70, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees, inclination::Radians>{}}, s, g, 200., 0, 0);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<inclination::Degrees, inclination::Radians>{}}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[0], -20., 1e-6);
  EXPECT_NEAR(a1[1], -0.2*pi, 1e-6);
...
TEST(basics, set_wrapped_component_polar_dynamic)
{
  ...
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  EXPECT_NEAR(a1[1], 0.8*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, 1.1*numbers::pi_v<long double>, 1, 0);
  EXPECT_NEAR(a1[1], -0.9*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, 190., 2, 0);
  EXPECT_NEAR(a1[2], -170, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 10, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -0.1*numbers::pi_v<long double>, 1, 0);
  EXPECT_NEAR(a1[1], 1.9*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -10., 2, 0);
  EXPECT_NEAR(a1[2], 350, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 170, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);
...
TEST(basics, set_wrapped_component_spherical_dynamic)
{
  ...
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, 1.1*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, 0.6*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.4*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -3., 1, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -0.6*pi, 3, 0);
  ...
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -2.6*pi, 3, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  ...
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  EXPECT_NEAR(a1[3], -pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 0.6*pi, 2, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.0, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 1.1*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -3., 1, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.1*pi, 1e-6);
  set_wrapped_component(DynamicDescriptor<double> {StaticDescriptor<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 3.4*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);
