...
namespace OpenKalman
{
  ...
  namespace detail
  {
    ...
    template<typename T>
    struct is_zero<T, std::enable_if_t<constant_matrix<T, CompileTimeStatus::known, Likelihood::maybe>>>
  ...
  concept zero = constant_matrix<T, CompileTimeStatus::known, Likelihood::maybe> and
