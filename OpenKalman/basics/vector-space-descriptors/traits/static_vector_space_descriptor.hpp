...
namespace OpenKalman
{
  ...
  concept static_vector_space_descriptor = std::default_initializable<std::decay_t<T>> and
    requires {
      {static_vector_space_descriptor_traits<std::decay_t<T>>::size} -> std::convertible_to<std::size_t>;
      {static_vector_space_descriptor_traits<std::decay_t<T>>::euclidean_size} -> std::convertible_to<std::size_t>;
      {static_vector_space_descriptor_traits<std::decay_t<T>>::component_count} -> std::convertible_to<std::size_t>;
      {static_vector_space_descriptor_traits<std::decay_t<T>>::always_euclidean} -> std::convertible_to<bool>;
      typename static_vector_space_descriptor_traits<std::decay_t<T>>::difference_type;
    };
#else
