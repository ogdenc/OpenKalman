...
namespace OpenKalman::internal
{
    ...
    struct uniform_static_vector_space_descriptor_query<StaticDescriptor<C>>
#else
    template<typename C>
    struct uniform_static_vector_space_descriptor_query<StaticDescriptor<C>, std::enable_if_t<dimension_size_of_v<C> == 1>>
#endif
    ...
    template<atomic_static_vector_space_descriptor C, static_vector_space_descriptor...Cs> requires (dimension_size_of_v<C> == 1) and
      (sizeof...(Cs) > 0) and equivalent_to<C, typename uniform_static_vector_space_descriptor_query<StaticDescriptor<Cs...>>::uniform_type>
    struct uniform_static_vector_space_descriptor_query<StaticDescriptor<C, Cs...>>
#else
    template<typename C, typename...Cs>
    struct uniform_static_vector_space_descriptor_query<StaticDescriptor<C, Cs...>, std::enable_if_t<
