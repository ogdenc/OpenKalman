...
/**
 * \file
 * \brief Definition for \ref vector_space_descriptor_components_of.
 */

#ifndef OPENKALMAN_VECTOR_SPACE_DESCRIPTOR_COMPONENTS_OF_HPP
#define OPENKALMAN_VECTOR_SPACE_DESCRIPTOR_COMPONENTS_OF_HPP
...
#endif
    : std::integral_constant<std::size_t, interface::fixed_vector_space_descriptor_traits<std::decay_t<T>>::component_count> {};
...
#endif //OPENKALMAN_VECTOR_SPACE_DESCRIPTOR_COMPONENTS_OF_HPP
