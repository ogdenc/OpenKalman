...
TEST(basics, DynamicDescriptor_traits)
{
  ...
  static_assert(not static_vector_space_descriptor<DynamicDescriptor<>>);
...
TEST(basics, DynamicDescriptor_construct)
{
  ...
  EXPECT_EQ(get_dimension_size_of(DynamicDescriptor {StaticDescriptor<Axis, inclination::Radians>{}, angle::Degrees{}, Dimensions{5}}), 8);
  EXPECT_EQ(get_euclidean_dimension_size_of(DynamicDescriptor {Dimensions{5}, StaticDescriptor<Axis, inclination::Radians>{}, angle::Degrees{}}), 10);
  EXPECT_EQ(get_euclidean_dimension_size_of(DynamicDescriptor {Dimensions{5}, StaticDescriptor<Axis, inclination::Radians>{}, DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}}, angle::Degrees{}}), 13);

  DynamicDescriptor d {Dimensions{5}, StaticDescriptor<Axis, inclination::Radians>{}};
  EXPECT_EQ(get_euclidean_dimension_size_of(DynamicDescriptor {d, DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}}, angle::Degrees{}}), 13);
  EXPECT_EQ(get_euclidean_dimension_size_of(DynamicDescriptor {std::move(d), DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}}, angle::Degrees{}}), 13);
}
...
TEST(basics, dynamic_comparison)
{
  ...
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<> {}} == DynamicDescriptor {StaticDescriptor<> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<> {}} == DynamicDescriptor {}));
  ...
  EXPECT_TRUE((DynamicDescriptor {Axis {}} == DynamicDescriptor {StaticDescriptor<Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {Axis {}} < DynamicDescriptor {StaticDescriptor<Axis, Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis> {}} == DynamicDescriptor {Axis {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis> {}} > DynamicDescriptor {Axis {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis> {}} == DynamicDescriptor {StaticDescriptor<Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis> {}} >= DynamicDescriptor {StaticDescriptor<Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}} == DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}} < DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis, Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis, Axis> {}} > DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}} == DynamicDescriptor {Axis {}, angle::Radians {}, Axis {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}} == DynamicDescriptor {Axis {}, angle::Radians {}, StaticDescriptor<Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}} == DynamicDescriptor {Axis {}, angle::Radians {}, StaticDescriptor<StaticDescriptor<Axis>> {}}));
  ...
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<StaticDescriptor<Axis>, angle::Radians, StaticDescriptor<Axis>> {}} == DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}}));
  ...
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, angle::Radians> {}} != DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians> {}} != DynamicDescriptor {Polar<Distance, angle::Radians> {}}));

  EXPECT_TRUE((DynamicDescriptor {Axis {}} == Dimensions<1>{}));
  EXPECT_TRUE((Dimensions<1>{} == DynamicDescriptor {Axis {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis> {}} == Dimensions<1>{}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis, Axis> {}} == Dimensions<3>{}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis> {}} < Dimensions<3>{}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions<4>{}} > StaticDescriptor<Axis, Axis> {}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions<4>{}} != StaticDescriptor<Axis, Axis> {}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions<3>{}, angle::Degrees{}} > Dimensions<3>{}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions<3>{}} < StaticDescriptor<Dimensions<3>, angle::Degrees>{}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions<3>{}, angle::Degrees{}, Dimensions<5>{}} == StaticDescriptor<Dimensions<3>, angle::Degrees, Dimensions<5>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, Dimensions<2>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} == StaticDescriptor<Dimensions<2>, Axis, angle::Degrees, Dimensions<2>, Dimensions<3>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, Dimensions<2>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} == StaticDescriptor<Dimensions<2>, Axis, angle::Degrees, Dimensions<2>, Dimensions<3>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, Dimensions<2>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} < StaticDescriptor<Dimensions<2>, Axis, angle::Degrees, Dimensions<2>, Dimensions<4>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, Dimensions<2>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} > StaticDescriptor<Dimensions<2>, Axis, angle::Degrees, Dimensions<2>, Dimensions<2>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, Dimensions<3>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} != StaticDescriptor<Dimensions<2>, Axis, angle::Degrees, Dimensions<2>, Dimensions<3>>{}));
  EXPECT_TRUE(not (DynamicDescriptor {Axis{}, Dimensions<2>{}, angle::Degrees{}, Dimensions<3>{}, Dimensions<2>{}} < StaticDescriptor<Dimensions<4>, angle::Degrees, Dimensions<3>, Dimensions<3>>{}));
  EXPECT_TRUE((DynamicDescriptor {Axis {}} == Dimensions{1}));
  EXPECT_TRUE((Dimensions{1} == DynamicDescriptor {Axis {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis> {}} == Dimensions{1}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis, Axis> {}} == Dimensions{3}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, Axis> {}} < Dimensions{3}));
  EXPECT_TRUE((DynamicDescriptor {Dimensions{4}} > StaticDescriptor<Axis, Axis> {}));
  EXPECT_TRUE((Dimensions{4} != DynamicDescriptor {StaticDescriptor<Axis, Axis> {}}));

  EXPECT_TRUE((StaticDescriptor<> {} == DynamicDescriptor {StaticDescriptor<> {}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}} == StaticDescriptor<Axis, angle::Radians>{}));
  EXPECT_TRUE((StaticDescriptor<Axis, angle::Radians>{} <= DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}}));
  EXPECT_TRUE((StaticDescriptor<Axis, angle::Radians>{} <= DynamicDescriptor {Axis{}, angle::Radians{}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}} >= StaticDescriptor<Axis, angle::Radians>{}));
  EXPECT_TRUE((StaticDescriptor<Axis, angle::Radians>{} < DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Axis>{}}));
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians>{}} <= StaticDescriptor<Axis, angle::Radians, Axis>{}));
  ...
  EXPECT_TRUE((DynamicDescriptor {StaticDescriptor<Axis, angle::Radians, Distance> {}} == DynamicDescriptor<long double> {StaticDescriptor<Axis, angle::Radians, Distance> {}}));
...
TEST(basics, dynamic_arithmetic)
{
  ...
  EXPECT_TRUE((DynamicDescriptor {Axis{}, angle::Radians{}} + StaticDescriptor<angle::Degrees, Axis>{} == DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}}));
  EXPECT_TRUE((StaticDescriptor<Axis, angle::Radians>{} + DynamicDescriptor {angle::Degrees{}, Axis{}} == DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}}));

  EXPECT_TRUE(Dimensions{7} - Dimensions{7} == Dimensions{0});
  EXPECT_TRUE(Dimensions{7} - Dimensions{4} == Dimensions{3});

  EXPECT_TRUE((DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}} - StaticDescriptor<>{} == DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}} - StaticDescriptor<Axis>{} == DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}}));
  EXPECT_TRUE((DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}} - StaticDescriptor<angle::Degrees, Axis>{} == DynamicDescriptor {Axis{}, angle::Radians{}}));
  ...
  EXPECT_TRUE((DynamicDescriptor {Axis{}, angle::Radians{}, angle::Degrees{}, Axis{}} - DynamicDescriptor {angle::Degrees{}, Axis{}} == StaticDescriptor<Axis, angle::Radians>{}));
}
...
TEST(basics, internal_replicate_vector_space_descriptor)
{
  ...
  // fixed:
  static_assert(std::is_same_v<decltype(replicate_vector_space_descriptor(StaticDescriptor<angle::Radians, Axis> {}, std::integral_constant<std::size_t, 2> {})), StaticDescriptor<StaticDescriptor<angle::Radians, Axis>, StaticDescriptor<angle::Radians, Axis>>>);
...
TEST(basics, internal_is_uniform_component_of)
{
  ...
  EXPECT_TRUE(is_uniform_component_of(DynamicDescriptor {Distance {}}, StaticDescriptor<Distance, Distance, Distance, Distance> {}));
...
TEST(basics, get_vector_space_descriptor_slice_dynamic)
{
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 0, 6) == StaticDescriptor<Dimensions<2>, Distance, Polar<Distance, angle::Radians>, Axis>{}));
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 0, 0) == StaticDescriptor<>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 1, 5) == StaticDescriptor<Axis, Distance, Polar<Distance, angle::Radians>, Axis>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 1, 4) == StaticDescriptor<Axis, Distance, Polar<Distance, angle::Radians>>{}));
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 1, 2) == StaticDescriptor<Axis, Distance>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 1, 1) == StaticDescriptor<Axis>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 1, 0) == StaticDescriptor<>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 2, 4) == StaticDescriptor<Distance, Polar<Distance, angle::Radians>, Axis>{}));
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 2, 3) == StaticDescriptor<Distance, Polar<Distance, angle::Radians>>{}));
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 2, 1) == StaticDescriptor<Distance>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 2, 0) == StaticDescriptor<>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 3, 3) == StaticDescriptor<Polar<Distance, angle::Radians>, Axis>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 3, 2) == StaticDescriptor<Polar<Distance, angle::Radians>>{}));
  ...
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 3, 0) == StaticDescriptor<>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 5, 1) == StaticDescriptor<Axis>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 5, 0) == StaticDescriptor<>{}));
  EXPECT_TRUE((get_vector_space_descriptor_slice(DynamicDescriptor {Dimensions<2>{}, Distance{}, Polar<Distance, angle::Radians>{}, Axis{}}, 6, 0) == StaticDescriptor<>{}));
