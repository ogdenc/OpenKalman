...
{
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis>{}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis>{}, g(-3.), 0, 0)), -3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians>{}, g(1.2*pi), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::PositiveRadians>{}, g(-0.2*pi), 0, 0)), 1.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Degrees>{}, g(200.), 0, 0)), -160., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::PositiveDegrees>{}, g(-20.), 0, 0)), 340., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Circle>{}, g(-0.2), 0, 0)), 0.8, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, angle::Radians>{}, g(3, 1.2*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, angle::Radians>{}, g(3, 1.2*pi), 1, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, Axis>{}, g(1.2*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, Axis>{}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}, g(1.2*pi, 5, 1.3*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}, g(1.2*pi, 5, 1.3*pi, 3), 1, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}, g(1.2*pi, 5, 1.3*pi, 3), 2, 0)), -0.7*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}, g(1.2*pi, 5, 1.3*pi, 3), 3, 0)), 3, 1e-6);
}


TEST(basics, get_wrapped_component_axis_angle_dynamic)
{
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis>{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis>{}}, g(-3.), 0, 0)), -3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians>{}}, g(1.2*pi), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::PositiveRadians>{}}, g(-0.2*pi), 0, 0)), 1.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Degrees>{}}, g(200.), 0, 0)), -160., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::PositiveDegrees>{}}, g(-20.), 0, 0)), 340., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Circle>{}}, g(-0.2), 0, 0)), 0.8, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, angle::Radians>{}}, g(3, 1.2*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, angle::Radians>{}}, g(3, 1.2*pi), 1, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, Axis>{}}, g(1.2*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, Axis>{}}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 1, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 2, 0)), -0.7*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g(1.2*pi, 5, 1.3*pi, 3), 3, 0)), 3, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g<double>(1.2*pi, 5, 1.3*pi, 3), 0, 0)), -0.8*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<double> {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g<double>(1.2*pi, 5, 1.3*pi, 3), 1, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<float> {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g<float>(1.2*pi, 5, 1.3*pi, 3), 2, 0)), -0.7*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<angle::Radians, TypedIndex<Axis, angle::Radians>, Axis>{}}, g<long double>(1.2*pi, 5, 1.3*pi, 3), 3, 0)), 3, 1e-6);
}


TEST(basics, get_wrapped_component_distance_inclination_fixed)
{
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Distance>{}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Distance>{}, g(-3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Radians>{}, g(0.7*pi), 0, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Radians>{}, g(1.2*pi), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Degrees>{}, g(110.), 0, 0)), 70., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Degrees>{}, g(200.), 0, 0)), -20., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Distance, inclination::Radians>{}, g(3, 0.7*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Distance, inclination::Radians>{}, g(3, 0.7*pi), 1, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Radians, Distance>{}, g(1.2*pi, 3), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<inclination::Radians, Distance>{}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);
}


TEST(basics, get_wrapped_component_distance_inclination_dynamic)
{
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Distance>{}}, g(3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Distance>{}}, g(-3.), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians>{}}, g(0.7*pi), 0, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians>{}}, g(1.2*pi), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Degrees>{}}, g(110.), 0, 0)), 70., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Degrees>{}}, g(200.), 0, 0)), -20., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Distance, inclination::Radians>{}}, g(3, 0.7*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Distance, inclination::Radians>{}}, g(3, 0.7*pi), 1, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians, Distance>{}}, g(1.2*pi, 3), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians, Distance>{}}, g(1.2*pi, 3), 1, 0)), 3, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Distance, inclination::Radians>{}}, g<long double>(3, 0.7*pi), 0, 0)), 3, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Distance, inclination::Radians>{}}, g<double>(3, 0.7*pi), 1, 0)), 0.3*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<float> {TypedIndex<inclination::Radians, Distance>{}}, g<float>(1.2*pi, 3), 0, 0)), -0.2*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<inclination::Radians, Distance>{}}, g<long double>(1.2*pi, 3), 1, 0)), 3, 1e-6);
}


TEST(basics, get_wrapped_component_polar_fixed)
{
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<Distance, angle::Radians>>{}, g(3., -2., 1.1*pi), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<Distance, angle::Radians>>{}, g(3., -2., 1.1*pi), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<Distance, angle::Radians>>{}, g(3., 2., 1.1*pi), 2, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<Distance, angle::Radians>>{}, g(3., -2., 1.1*pi), 2, 0)), 0.1*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}, g(190., 2., 4.), 0, 0)), -170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}, g(190., -2., 4.), 0, 0)), 10, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}, g(190., -2., 4.), 1, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}, g(190., -2., -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}, g(-2., -0.1*pi, 4.), 0, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}, g(2., -0.1*pi, 4.), 1, 0)), 1.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}, g(-2., -0.1*pi, 4.), 1, 0)), 0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}, g(-2., -0.1*pi, -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}, g(5., -10., 2.), 0, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}, g(5., -10., 2.), 1, 0)), 350, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}, g(5., -10., -2.), 1, 0)), 170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}, g(5., -10., -2.), 2, 0)), 2, 1e-6);
}


TEST(basics, get_wrapped_component_polar_dynamic)
{
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 0, 0)), 3., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 1, 0)), 2., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<Distance, angle::Radians>>{}}, g(3., 2., 1.1*pi), 2, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<Distance, angle::Radians>>{}}, g(3., -2., 1.1*pi), 2, 0)), 0.1*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., 2., 4.), 0, 0)), -170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., 4.), 0, 0)), 10, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., 4.), 1, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<angle::Degrees, Distance>, Axis>{}}, g(190., -2., -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, 4.), 0, 0)), 2, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(2., -0.1*pi, 4.), 1, 0)), 1.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, 4.), 1, 0)), 0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Axis>{}}, g(-2., -0.1*pi, -4.), 2, 0)), -4, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., 2.), 0, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., 2.), 1, 0)), 350, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., -2.), 1, 0)), 170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g(5., -10., -2.), 2, 0)), 2, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g<float>(5., -10., 2.), 0, 0)), 5, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g<double>(5., -10., 2.), 1, 0)), 350, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<float> {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g<float>(5., -10., -2.), 1, 0)), 170, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<Axis, Polar<angle::PositiveDegrees, Distance>>{}}, g<long double>(5., -10., -2.), 2, 0)), 2, 1e-6);
}
...
TEST(basics, get_wrapped_component_spherical_fixed)
{
  ...
  EXPECT_NEAR((get_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);
}


TEST(basics, get_wrapped_component_spherical_dynamic)
{
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 0, 0)), 2., 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 0.5*pi, 0.6*pi), 1, 0)), -0.5*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 0.5*pi, 0.6*pi), 2, 0)), 0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 0.5*pi, 0.6*pi), 1, 0)), 0.5*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 0.5*pi, 0.6*pi), 2, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 1, 0)), 0.1*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(2., 1.1*pi, 0.6*pi), 2, 0)), 0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 1.1*pi, 0.6*pi), 1, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(-2., 1.1*pi, 0.6*pi), 2, 0)), -0.4*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {DynamicTypedIndex{Axis{}}, Spherical<Distance, angle::Radians, inclination::Radians>{}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Axis{}, DynamicTypedIndex{Spherical<Distance, angle::Radians, inclination::Radians>{}}}, g(3., -2., 1.1*pi, 0.6*pi), 3, 0)), -0.4*pi, 1e-6);

  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g<float>(2., 1.1*pi, 0.6*pi), 1, 0)), 0.1*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g<double>(2., 1.1*pi, 0.6*pi), 2, 0)), 0.4*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<float> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g<float>(-2., 1.1*pi, 0.6*pi), 1, 0)), -0.9*pi, 1e-6);
  EXPECT_NEAR((get_wrapped_component(DynamicTypedIndex<long double> {Spherical<Distance, angle::Radians, inclination::Radians>{}}, g<long double>(-2., 1.1*pi, 0.6*pi), 2, 0)), -0.4*pi, 1e-6);
}
...
TEST(basics, set_wrapped_component_axis_angle)
{
  ...
  set_wrapped_component(TypedIndex<Axis, Axis>{}, s, g, 2.1, 1, 0);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(TypedIndex<Axis, angle::Radians>{}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[1], -0.8*pi, 1e-6);
  set_wrapped_component(TypedIndex<angle::PositiveRadians, Axis>{}, s, g, -0.2*pi, 0, 0);
  EXPECT_NEAR(a1[0], 1.8*pi, 1e-6);
  set_wrapped_component(TypedIndex<angle::Degrees, Axis>{}, s, g, 200., 0, 0);
  EXPECT_NEAR(a1[0], -160, 1e-6);
  set_wrapped_component(TypedIndex<Axis, angle::PositiveDegrees>{}, s, g, -20., 1, 0);
  EXPECT_NEAR(a1[1], 340, 1e-6);
  set_wrapped_component(TypedIndex<Axis, angle::Circle>{}, s, g, -0.2, 1, 0);
  EXPECT_NEAR(a1[1], 0.8, 1e-6);

  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Axis>{}}, s, g, 2.1, 1, 0);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, angle::Radians>{}}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[1], -0.8*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<angle::PositiveRadians, Axis>{}}, s, g, -0.2*pi, 0, 0);
  EXPECT_NEAR(a1[0], 1.8*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<angle::Degrees, Axis>{}}, s, g, 200., 0, 0);
  EXPECT_NEAR(a1[0], -160, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, angle::PositiveDegrees>{}}, s, g, -20., 1, 0);
  EXPECT_NEAR(a1[1], 340, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, angle::Circle>{}}, s, g, -0.2, 1, 0);
  EXPECT_NEAR(a1[1], 0.8, 1e-6);

  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Axis>{}}, s, g, 2.1, 1, 0);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, angle::Radians>{}}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[1], -0.8*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<angle::PositiveRadians, Axis>{}}, s, g, -0.2*pi, 0, 0);
  EXPECT_NEAR(a1[0], 1.8*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<angle::Degrees, Axis>{}}, s, g, 200., 0, 0);
  EXPECT_NEAR(a1[0], -160, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, angle::PositiveDegrees>{}}, s, g, -20., 1, 0);
  EXPECT_NEAR(a1[1], 340, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, angle::Circle>{}}, s, g, -0.2, 1, 0);
  EXPECT_NEAR(a1[1], 0.8, 1e-6);
}
...
TEST(basics, set_wrapped_component_distance_inclination)
{
  ...
  set_wrapped_component(TypedIndex<Distance, Distance>{}, s, g, 2.1, 0, 0);
  set_wrapped_component(TypedIndex<Distance, Distance>{}, s, g, -2.1, 1, 0);
  EXPECT_NEAR(a1[0], 2.1, 1e-6);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(TypedIndex<inclination::Radians, inclination::Degrees>{}, s, g, 0.7*pi, 0, 0);
  set_wrapped_component(TypedIndex<inclination::Radians, inclination::Degrees>{}, s, g, 110., 1, 0);
  EXPECT_NEAR(a1[0], 0.3*pi, 1e-6);
  EXPECT_NEAR(a1[1], 70, 1e-6);
  set_wrapped_component(TypedIndex<inclination::Degrees, inclination::Radians>{}, s, g, 200., 0, 0);
  set_wrapped_component(TypedIndex<inclination::Degrees, inclination::Radians>{}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[0], -20., 1e-6);
  EXPECT_NEAR(a1[1], -0.2*pi, 1e-6);

  set_wrapped_component(DynamicTypedIndex {TypedIndex<Distance, Distance>{}}, s, g, 2.1, 0, 0);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Distance, Distance>{}}, s, g, -2.1, 1, 0);
  EXPECT_NEAR(a1[0], 2.1, 1e-6);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians, inclination::Degrees>{}}, s, g, 0.7*pi, 0, 0);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Radians, inclination::Degrees>{}}, s, g, 110., 1, 0);
  EXPECT_NEAR(a1[0], 0.3*pi, 1e-6);
  EXPECT_NEAR(a1[1], 70, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Degrees, inclination::Radians>{}}, s, g, 200., 0, 0);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<inclination::Degrees, inclination::Radians>{}}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[0], -20., 1e-6);
  EXPECT_NEAR(a1[1], -0.2*pi, 1e-6);

  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<Distance, Distance>{}}, s, g, 2.1, 0, 0);
  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<Distance, Distance>{}}, s, g, -2.1, 1, 0);
  EXPECT_NEAR(a1[0], 2.1, 1e-6);
  EXPECT_NEAR(a1[1], 2.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<inclination::Radians, inclination::Degrees>{}}, s, g, 0.7*pi, 0, 0);
  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<inclination::Radians, inclination::Degrees>{}}, s, g, 110., 1, 0);
  EXPECT_NEAR(a1[0], 0.3*pi, 1e-6);
  EXPECT_NEAR(a1[1], 70, 1e-6);
  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<inclination::Degrees, inclination::Radians>{}}, s, g, 200., 0, 0);
  set_wrapped_component(DynamicTypedIndex<float> {TypedIndex<inclination::Degrees, inclination::Radians>{}}, s, g, 1.2*pi, 1, 0);
  EXPECT_NEAR(a1[0], -20., 1e-6);
  EXPECT_NEAR(a1[1], -0.2*pi, 1e-6);
}
...
TEST(basics, set_wrapped_component_polar_fixed)
{
  ...
  set_wrapped_component(TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  EXPECT_NEAR(a1[1], -0.2*pi, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}, s, g, 1.1*pi, 1, 0);
  EXPECT_NEAR(a1[1], -0.9*pi, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}, s, g, 190., 2, 0);
  EXPECT_NEAR(a1[2], -170, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 10, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}, s, g, -0.1*pi, 1, 0);
  EXPECT_NEAR(a1[1], 1.9*pi, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}, s, g, -10., 2, 0);
  EXPECT_NEAR(a1[2], 350, 1e-6);
  set_wrapped_component(TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 170, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);
}
...
TEST(basics, set_wrapped_component_polar_dynamic)
{
  ...
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  EXPECT_NEAR(a1[1], 0.8*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, 1.1*numbers::pi_v<long double>, 1, 0);
  EXPECT_NEAR(a1[1], -0.9*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, 190., 2, 0);
  EXPECT_NEAR(a1[2], -170, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::Radians>, Polar<angle::Degrees, Distance>>{}}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 10, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -0.1*numbers::pi_v<long double>, 1, 0);
  EXPECT_NEAR(a1[1], 1.9*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -10., 2, 0);
  EXPECT_NEAR(a1[2], 350, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 170, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 0, 0);
  EXPECT_NEAR(a1[0], 2, 1e-6);
  set_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -0.1*numbers::pi_v<long double>, 1, 0);
  EXPECT_NEAR(a1[1], 1.9*numbers::pi_v<long double>, 1e-6);
  set_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -10., 2, 0);
  EXPECT_NEAR(a1[2], 350, 1e-6);
  set_wrapped_component(DynamicTypedIndex<long double> {TypedIndex<Polar<Distance, angle::PositiveRadians>, Polar<angle::PositiveDegrees, Distance>>{}}, s, g, -2., 3, 0);
  EXPECT_NEAR(a1[2], 170, 1e-6);
  EXPECT_NEAR(a1[3], 2, 1e-6);
}
...
TEST(basics, set_wrapped_component_spherical_fixed)
{
  ...
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, 1.1*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, 0.6*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.4*pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, -3., 1, 0);
  ...
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}, s, g, -2.6*pi, 3, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  ...
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  EXPECT_NEAR(a1[3], -pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, 0.6*pi, 2, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.0, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, 1.1*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, -3., 1, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.1*pi, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}, s, g, 3.4*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, -2., 2, 0);
  EXPECT_NEAR(a1[2], 2, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, -170., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, 100., 3, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, 550., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}, s, g, -3., 2, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
...
TEST(basics, set_wrapped_component_spherical_dynamic)
{
  ...
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, 1.1*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, 0.6*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.4*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -3., 1, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -0.6*pi, 3, 0);
  ...
  EXPECT_NEAR(a1[2], 0.1*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, angle::Radians, inclination::Radians>>{}}, s, g, -2.6*pi, 3, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.9*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.4*pi, 1e-6);
  ...
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -2., 1, 0);
  EXPECT_NEAR(a1[1], 2, 1e-6);
  EXPECT_NEAR(a1[3], -pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 0.6*pi, 2, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.0, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 1.1*pi, 3, 0);
  EXPECT_NEAR(a1[2], 0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, -3., 1, 0);
  EXPECT_NEAR(a1[1], 3, 1e-6);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], 0.1*pi, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<Distance, inclination::Radians, angle::Radians>>{}}, s, g, 3.4*pi, 2, 0);
  EXPECT_NEAR(a1[2], -0.4*pi, 1e-6);
  EXPECT_NEAR(a1[3], -0.9*pi, 1e-6);

  a1 = {0, 0, 0, 0};

  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -2., 2, 0);
  EXPECT_NEAR(a1[2], 2, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -170., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, 100., 3, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, 550., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(DynamicTypedIndex {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -3., 2, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
  EXPECT_NEAR(a1[2], 3, 1e-6);
  EXPECT_NEAR(a1[3], -80, 1e-6);
  ...
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -3.1, 0, 0);
  EXPECT_NEAR(a1[0], -3.1, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -2., 2, 0);
  EXPECT_NEAR(a1[2], 2, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -170., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, 100., 3, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, 550., 1, 0);
  EXPECT_NEAR(a1[1], 190, 1e-6);
  EXPECT_NEAR(a1[3], 80, 1e-6);
  set_wrapped_component(DynamicTypedIndex<double> {TypedIndex<Axis, Spherical<angle::PositiveDegrees, Distance, inclination::Degrees>>{}}, s, g, -3., 2, 0);
  EXPECT_NEAR(a1[1], 10, 1e-6);
  EXPECT_NEAR(a1[2], 3, 1e-6);
  EXPECT_NEAR(a1[3], -80, 1e-6);
}
