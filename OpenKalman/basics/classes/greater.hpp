...
/**
 * \file
 * \brief Definition of \ref greater.
 */

#ifndef OPENKALMAN_GREATER_HPP
#define OPENKALMAN_GREATER_HPP
...
{
  /**
   * \brief A generalization of std::greater in which the arguments may be of different types.
   */
  ...
  struct greater<void>
  {
...
#endif
    {
      ...
      if constexpr (is_arithmetic_v<Lhs> and is_arithmetic_v<Rhs>)
        return stdcompat::cmp_greater(lhs, rhs);
      else
        return lhs > rhs;
    }
  };
