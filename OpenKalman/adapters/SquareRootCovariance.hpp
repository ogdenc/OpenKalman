...
namespace OpenKalman
{
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type = TriangleType::lower, typed_matrix_nestable Arg>
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type, typed_matrix_nestable Arg> requires square_shaped<Arg>
#else
