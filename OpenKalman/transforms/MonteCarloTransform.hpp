...
namespace OpenKalman
{
  ...
  private:
    ...
    private:
      ...
      static_assert((patterns::compares_with<OutputCoefficients,
      ...
      using InputMeanMatrix = dense_writable_matrix_t<In_Mean, data_layout::none, Scalar,
        std::tuple<patterns::dimension_of<InputCoefficients>, Axis>>;
      using OutputEuclideanMeanMatrix = dense_writable_matrix_t<InputMeanMatrix, data_layout::none, Scalar, std::tuple<patterns::dimension_of<OutputCoefficients>, Axis>>;
      using OutputCovarianceMatrix = dense_writable_matrix_t<InputMeanMatrix, data_layout::none, Scalar,
        std::tuple<patterns::dimension_of<OutputCoefficients>, patterns::dimension_of<OutputCoefficients>>>;
      ...
      using CrossCovarianceMatrix = dense_writable_matrix_t<InputMeanMatrix, data_layout::none, Scalar,
        std::tuple<patterns::dimension_of<InputCoefficients>, patterns::dimension_of<OutputCoefficients>>>;
    ...
    public:
      ...
      one(const TransformationType& trans, const InputDistribution& dist, const NoiseDistributions&...noise)
      {
        ...
        if constexpr (return_cross)
          return MonteCarloSum {1, x, to_stat_space(y), make_zero<OutputCovariance>(),
      ...
      struct MonteCarloBinaryOp
      {
        auto operator()(const MonteCarloSum& set1, const MonteCarloSum& set2)
        {
          ...
          if (set2.count == 1) // This is most likely. Take advantage of prior knowledge of set2.
          {
            ...
            const auto delta = from_stat_space(set2.y_E) - from_stat_space(set1.y_E);
  ...
  public:
    ...
    auto operator()(const InputDist& x, const Trans& transformation, const NoiseDists& ...n) const
    {
      ...
      auto mean_output = make_self_contained(from_stat_space(m_sum.y_E));
