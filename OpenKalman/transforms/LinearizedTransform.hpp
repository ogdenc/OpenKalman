  ...
  class LinearizedTransform : public oin::LinearTransformBase<LinearizedTransform<order>>
  {
    ...
    private:
      ...
      static auto second_order_term(const Hessian& hessian, const Dist& x)
      {
        ...
        static_assert(output_dim == dimension_size_of_v<OutputCoeffs>);
        ...
        using MeanOut = untyped_dense_writable_matrix_t<CovIn, Layout::none, scalar_type_of_t<CovIn>, output_dim, 1>;
    ...
    public:
      ...
      auto add_correction(const InputDist& x, const Noise& ... n) const
      {
        ...
        using OutputCoeffs = vector_space_descriptor_of_t<Out_Mean, 0>;
