...
#ifndef OPENKALMAN_VALUES_ACOSH_HPP
#define OPENKALMAN_VALUES_ACOSH_HPP
...
namespace OpenKalman::values
{
  ...
  template<value Arg>
  constexpr value auto acosh(const Arg& arg)
#else
...
#endif
  {
    ...
    {
      struct Op { constexpr auto operator()(const value_type_of_t<Arg>& a) const { return values::acosh(a); } };
