...
#ifndef OPENKALMAN_VALUES_ATANH_HPP
#define OPENKALMAN_VALUES_ATANH_HPP
...
namespace OpenKalman::values
{
  ...
  template<value Arg>
  constexpr value auto atanh(const Arg& arg)
#else
...
#endif
  {
    ...
    {
      struct Op { constexpr auto operator()(const value_type_of_t<Arg>& a) const { return values::atanh(a); } };
