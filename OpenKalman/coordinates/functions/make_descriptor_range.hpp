...
/**
 * \file
 * \brief Definition for \ref coordinates::make_descriptor_range.
 */

#ifndef OPENKALMAN_COORDINATES_MAKE_DESCRIPTOR_RANGE_HPP
#define OPENKALMAN_COORDINATES_MAKE_DESCRIPTOR_RANGE_HPP
