...
namespace std
{
  ...
  template<typename T, auto...M, std::size_t N>
  struct common_type<OpenKalman::values::fixed_value<T, M...>, OpenKalman::coordinates::Dimensions<N>>
    : common_type<OpenKalman::coordinates::Dimensions<N>, OpenKalman::values::fixed_value<T, M...>> {};
