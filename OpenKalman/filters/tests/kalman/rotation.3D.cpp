...
{
  rotation_3D<hermitian_adapter<M33>>(LinearTransform());
}

TEST(kalman, rotation_3D_linear_T)
{
  rotation_3D<triangular_adapter<M33>>(LinearTransform());
}

TEST(kalman, rotation_3D_linearized_SA)
{
  rotation_3D<hermitian_adapter<M33>>(LinearizedTransform<2>());
}

TEST(kalman, rotation_3D_linearized_T)
{
  rotation_3D<triangular_adapter<M33>>(LinearizedTransform<2>());
}

TEST(kalman, rotation_3D_cubature_SA)
{
  rotation_3D<hermitian_adapter<M33>>(CubatureTransform());
}

TEST(kalman, rotation_3D_cubature_T)
{
  rotation_3D<triangular_adapter<M33>>(CubatureTransform());
}

TEST(kalman, rotation_3D_unscented_SA)
{
  rotation_3D<hermitian_adapter<M33>>(SamplePointsTransform<UnscentedSigmaPointsParameterEstimation>());
}

TEST(kalman, rotation_3D_unscented_T)
{
  rotation_3D<triangular_adapter<M33>>(SamplePointsTransform<UnscentedSigmaPointsParameterEstimation>());
}

TEST(kalman, rotation_3D_simplex_SA)
{
  rotation_3D<hermitian_adapter<M33>>(SamplePointsTransform<SphericalSimplexSigmaPoints>());
}

TEST(kalman, rotation_3D_simplex_T)
{
  rotation_3D<triangular_adapter<M33>>(SamplePointsTransform<SphericalSimplexSigmaPoints>());
}
