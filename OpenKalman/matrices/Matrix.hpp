...
namespace OpenKalman
{
  ...
  public:
    ...
    template<covariance Arg> requires
      equivalent_to<row_index_descriptor_of_t<Arg>, RowCoefficients> and
      equivalent_to<row_index_descriptor_of_t<Arg>, ColumnCoefficients> and
    ...
    template<typed_matrix Arg> requires
      equivalent_to<row_index_descriptor_of_t<Arg>, RowCoefficients> and
      equivalent_to<column_index_descriptor_of_t<Arg>, ColumnCoefficients>
#else
  ...
  Matrix(V&&) -> Matrix<
    ...
    column_index_descriptor_of_t<V>,
  ...
  Matrix(V&&) -> Matrix<
    row_index_descriptor_of_t<V>,
    column_index_descriptor_of_t<V>,
    decltype(from_euclidean<row_index_descriptor_of_t<V>>(
  ...
  {
    using RowCoeffs = row_index_descriptor_of_t<Arg>;
    using ColCoeffs = column_index_descriptor_of_t<Arg>;
