...
namespace OpenKalman
{
  ...
  Mean(V&&) -> Mean<vector_space_descriptor_of_t<V, 0>, std::decay_t<decltype(
    wrap_angles<vector_space_descriptor_of_t<V, 0>>(nested_matrix(std::forward<V>(std::declval<V>()))))>>;
...
#endif
  Mean(V&&) -> Mean<vector_space_descriptor_of_t<V, 0>, std::decay_t<decltype(
    from_euclidean<vector_space_descriptor_of_t<V, 0>>(nested_matrix(std::forward<V>(std::declval<V>()))))>>;
