...
TEST(matrices, Mean_blocks)
{
  ...
  EXPECT_TRUE(is_near(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6}),
    Matrix<C2, StaticDescriptor<Axis, Axis, angle::Radians>, M23> {1, 2, 3, 4-2*pi, 5-2*pi, 6}));
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6})), 1>, StaticDescriptor<Axis, Axis, angle::Radians>>);
...
{
  const auto v0 = make_mean<StaticDescriptor<angle::Radians, Axis>>(eigen_matrix_t<double, 2, 1>(0.5, 2));
  EXPECT_EQ(v0[0], 0.5);
  EXPECT_EQ(v0[1], 2);
  const auto v1 = make_mean<StaticDescriptor<Axis, angle::Radians>>(6., 7);
  EXPECT_EQ(v1[0], 6);
  EXPECT_EQ(v1[1], 7-2*pi);
  const auto v2 = make_mean<StaticDescriptor<angle::Radians, Axis, angle::Radians>>(7., 8, 9);
  ...
  m33 << 9, 3, 1,
    3, 8 - pi*2, 2,
    7, 1, 8;
  auto v3 = make_mean<double, StaticDescriptor<Axis, angle::Radians, Axis>, 3>();
  v3 << 9, 3, 1,
    3, 8, 2,
    7, 1, 8;
  EXPECT_TRUE(is_near(nested_object(v3), m33));
  auto v3_1 = make_mean<StaticDescriptor<Axis, angle::Radians, Axis>>(9., 3, 1, 3, 8, 2, 7, 1, 8);
  ...
  auto v3_3 = make_mean<double, StaticDescriptor<Axis, angle::Radians, Axis>, 3>();
...
{
  using C3 = StaticDescriptor<angle::Radians, Axis, angle::Radians>;
  using Var3 = Mean<C3>;
  auto x1 = Var3 {5., 7, 9};
  auto x2 = Var3 {3., 2, 1};
  ...
  const Mean<StaticDescriptor<angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians>>
  ...
  const Mean<StaticDescriptor<angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians>>
...
{
  using Var3 = Mean<StaticDescriptor<angle::Radians, Axis, angle::Radians>>;
...
{
  using M = Matrix<StaticDescriptor<Axis, angle::Radians>, StaticDescriptor<Axis, angle::Radians, Axis>>;
  using Vm = Mean<StaticDescriptor<Axis, angle::Radians, Axis>>;
  using Rm = Matrix<StaticDescriptor<Axis, angle::Radians>, Axis>;
  const M m {1, -2, 4,
             -5, 2, -1};
  const Vm vm {2, 1, -1};
  const Rm rm {-4, -7};
  static_assert(std::is_same_v<vector_space_descriptor_of_t<decltype(make_self_contained(m*vm)), 0>, StaticDescriptor<Axis, angle::Radians>>);
...
{
  using C = StaticDescriptor<angle::Radians, Axis, angle::Radians, Axis, Axis>;
  using Var3 = Mean<C>;
  Var3 v1 {1, 2, 3, 4, 5};
  Var3 v2 {2, 4, -6, 8, -10};
  Var3 v3 {3, 6, -3, 12, -5};
...
{
  using Var3 = Mean<StaticDescriptor<angle::PositiveRadians, Axis, angle::PositiveRadians>>;
...
{
  using Var3 = Mean<StaticDescriptor<angle::PositiveDegrees, Axis, angle::PositiveDegrees>>;
...
{
  using Var3 = Mean<StaticDescriptor<angle::Radians, Axis>, eigen_matrix_t<double, 2, 2>>;
  using TVar3 = Matrix<StaticDescriptor<angle::Radians, Axis>, Dimensions<2>, eigen_matrix_t<double, 2, 2>>;
  Var3 v1 {1, 2, 3, 4};
  Var3 v2 {6, 4, -6, 8};
...
{
  using R = Mean<StaticDescriptor<angle::Radians, Polar<Distance, angle::Radians>>>;
  ...
  using Q = Mean<StaticDescriptor<Polar<angle::Radians, Distance>, angle::Radians>>;
