...
TEST(matrices, Mean_deduction_guides)
{
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mean(a)), 0>, Dimensions<2>>);

  auto b1 = Mat23 {1, 2, 3, 4, 5, 6};
  EXPECT_TRUE(is_near(Mean(b1), Mat23 {1, 2, 3, 4, 5, 6}));
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mean(b1)), 0>, C2>);

  auto b2 = Matrix<C2, Dimensions<3>, M23> {1, 2, 3, 4, 5, 6};
  EXPECT_TRUE(is_near(Mean(b2), Mat23 {1, 2, 3, 4, 5, 6}));
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mean(b2)), 0>, C2>);
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mean(b3)), 0>, C2>);
...
TEST(matrices, Mean_make_functions)
{
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(make_mean<C2>(a)), 0>, C2>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(make_mean<C2>(a)), 1>, Dimensions<3>>);

  auto b = Mat23 {1, 2, 3, 4, 5, 6};
  EXPECT_TRUE(is_near(make_mean(b), Mat23{a}));
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(make_mean(b)), 0>, C2>);

  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(make_mean<C2, M23>()), 0>, C2>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(make_mean<M23>()), 0>, Dimensions<2>>);
}
...
TEST(matrices, Mean_overloads)
{
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(to_diagonal(Mat21 {5, 6})), 1>, C2>);
...
TEST(matrices, Mean_blocks)
{
  ...
  EXPECT_TRUE(is_near(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6}),
    Matrix<C2, FixedDescriptor<Axis, Axis, angle::Radians>, M23> {1, 2, 3, 4-2*pi, 5-2*pi, 6}));
  static_assert(not mean<decltype(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6}))>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6})), 0>, C2>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(concatenate_horizontal(Mat22 {1, 2, 4, 5}, Matrix<C2, angle::Radians, M21> {3, 6})), 1>, FixedDescriptor<Axis, Axis, angle::Radians>>);
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(column<1>(Mat22 {1, 2, 3, 4})), 1>, Axis>);
...
TEST(matrices, Mean_arithmetic)
{
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mat22 {1, 2, 3, 4} * Mean<Dimensions<2>, M23> {1, 2, 3, 4, 5, 6}), 0>, C2>);
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mat22 {1, 2, 3, 4} * Matrix<Dimensions<2>, Dimensions<3>, M23> {1, 2, 3, 4, 5, 6}), 0>, C2>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mat22 {1, 2, 3, 4} * Matrix<Dimensions<2>, Dimensions<3>, M23> {1, 2, 3, 4, 5, 6}), 1>, Dimensions<3>>);
  ...
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mat22 {1, 2, 3, 4} * Matrix<Dimensions<2>, C3, M23> {1, 2, 3, 4, 5, 6}), 0>, C2>);
  static_assert(equivalent_to<vector_space_descriptor_of_t<decltype(Mat22 {1, 2, 3, 4} * Matrix<Dimensions<2>, C3, M23> {1, 2, 3, 4, 5, 6}), 1>, C3>);
...
{
  const auto v0 = make_mean<FixedDescriptor<angle::Radians, Axis>>(eigen_matrix_t<double, 2, 1>(0.5, 2));
  EXPECT_EQ(v0[0], 0.5);
  EXPECT_EQ(v0[1], 2);
  const auto v1 = make_mean<FixedDescriptor<Axis, angle::Radians>>(6., 7);
  EXPECT_EQ(v1[0], 6);
  EXPECT_EQ(v1[1], 7-2*pi);
  const auto v2 = make_mean<FixedDescriptor<angle::Radians, Axis, angle::Radians>>(7., 8, 9);
  ...
  m33 << 9, 3, 1,
    3, 8 - pi*2, 2,
    7, 1, 8;
  auto v3 = make_mean<double, FixedDescriptor<Axis, angle::Radians, Axis>, 3>();
  v3 << 9, 3, 1,
    3, 8, 2,
    7, 1, 8;
  EXPECT_TRUE(is_near(nested_object(v3), m33));
  auto v3_1 = make_mean<FixedDescriptor<Axis, angle::Radians, Axis>>(9., 3, 1, 3, 8, 2, 7, 1, 8);
  ...
  auto v3_3 = make_mean<double, FixedDescriptor<Axis, angle::Radians, Axis>, 3>();
...
{
  using C3 = FixedDescriptor<angle::Radians, Axis, angle::Radians>;
  using Var3 = Mean<C3>;
  auto x1 = Var3 {5., 7, 9};
  auto x2 = Var3 {3., 2, 1};
  auto x3 = Mean<concatenate_fixed_vector_space_descriptor_t<C3, C3>> {5., 7, 9, 3, 2, 1};
  EXPECT_TRUE(is_near(concatenate(x1, x2), x3));
  auto x4 = Mean<concatenate_fixed_vector_space_descriptor_t<C3, C3, C3>> {5., 7, 9, 3, 2, 1, 5, 7, 9};
  ...
  const Mean<FixedDescriptor<angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians>>
  ...
  const Mean<FixedDescriptor<angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians, angle::Radians, Axis, angle::Radians>>
...
{
  using Var3 = Mean<FixedDescriptor<angle::Radians, Axis, angle::Radians>>;
...
{
  using M = Matrix<FixedDescriptor<Axis, angle::Radians>, FixedDescriptor<Axis, angle::Radians, Axis>>;
  using Vm = Mean<FixedDescriptor<Axis, angle::Radians, Axis>>;
  using Rm = Matrix<FixedDescriptor<Axis, angle::Radians>, Axis>;
  const M m {1, -2, 4,
             -5, 2, -1};
  const Vm vm {2, 1, -1};
  const Rm rm {-4, -7};
  static_assert(std::is_same_v<vector_space_descriptor_of_t<decltype(make_self_contained(m*vm)), 0>, FixedDescriptor<Axis, angle::Radians>>);
...
{
  using C = FixedDescriptor<angle::Radians, Axis, angle::Radians, Axis, Axis>;
  using Var3 = Mean<C>;
  Var3 v1 {1, 2, 3, 4, 5};
  Var3 v2 {2, 4, -6, 8, -10};
  Var3 v3 {3, 6, -3, 12, -5};
...
{
  using Var3 = Mean<FixedDescriptor<angle::PositiveRadians, Axis, angle::PositiveRadians>>;
...
{
  using Var3 = Mean<FixedDescriptor<angle::PositiveDegrees, Axis, angle::PositiveDegrees>>;
...
{
  using Var3 = Mean<FixedDescriptor<angle::Radians, Axis>, eigen_matrix_t<double, 2, 2>>;
  using TVar3 = Matrix<FixedDescriptor<angle::Radians, Axis>, Dimensions<2>, eigen_matrix_t<double, 2, 2>>;
  Var3 v1 {1, 2, 3, 4};
  Var3 v2 {6, 4, -6, 8};
...
{
  using R = Mean<FixedDescriptor<angle::Radians, Polar<Distance, angle::Radians>>>;
  ...
  using Q = Mean<FixedDescriptor<Polar<angle::Radians, Distance>, angle::Radians>>;
