...
TEST(covariance_tests, Covariance_mult_scalar)
{
  ...
  Eigen3::HermitianAdapter<I2, triangle_type::lower> sai2 {I2::Identity()};
...
TEST(covariance_tests, Covariance_scale)
{
  ...
  using CovSA3l = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, HermitianAdapter<M3, triangle_type::lower>>;
  using CovSA3u = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, HermitianAdapter<M3, triangle_type::upper>>;
  using CovT3l = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, TriangularAdapter<M3, triangle_type::lower>>;
  using CovT3u = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, TriangularAdapter<M3, triangle_type::upper>>;
  using CovD3 = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, diagonal_adapter<eigen_matrix_t<double, 3, 1>>>;
  Mat3 q1 {4, 2, 2,
           2, 5, 3,
           2, 3, 6};
