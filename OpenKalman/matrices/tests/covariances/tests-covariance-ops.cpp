...
inline zero_adapter<eigen_matrix_t<double, 2, 2>> z2;
...
TEST(covariance_tests, Covariance_addition)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} + covz2).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} + covz2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovD2 {9, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovD2 {9, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovD2 {9, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovD2 {9, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((covi2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covi2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((covi2 + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covi2 + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((covz2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covz2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((covz2 + CovT2l {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((covz2 + CovT2u {4, 2, 2, 5}).get_triangular_nested_matrix()), triangle_type::upper>);
...
TEST(covariance_tests, Covariance_addition_mixed)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2l {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovT2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} + sqcovz2).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((CovT2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} + sqcovz2).get_triangular_nested_matrix()), triangle_type::upper>);
...
TEST(covariance_tests, Covariance_subtraction)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((covz2 - CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covz2 - CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype((covz2 - CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covz2 - CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(diagonal_matrix<decltype((covz2 - CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_mult_covariance)
{
  ...
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} * covi2).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(triangular_matrix<decltype((CovT2l {9, 3, 3, 10} * sqcovi2).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} * covi2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(triangular_matrix<decltype((CovT2u {9, 3, 3, 10} * sqcovi2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((covi2 * CovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covi2 * CovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((covi2 * CovT2l {9, 3, 3, 10}).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((covi2 * CovT2u {9, 3, 3, 10}).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((covi2 * SqCovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((covi2 * SqCovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((covi2 * SqCovT2l {9, 3, 3, 10}).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((covi2 * SqCovT2u {9, 3, 3, 10}).get_triangular_nested_matrix()), triangle_type::upper>);
...
TEST(covariance_tests, Covariance_mult_TypedMatrix)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((covSA2l * mati2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((covSA2u * mati2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(triangular_matrix<decltype((covT2l * mati2).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(triangular_matrix<decltype((covT2u * mati2).get_triangular_nested_matrix()), triangle_type::upper>);
...
TEST(covariance_tests, Covariance_mult_scalar)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2l(p1) * 2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u(p1) * 2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2l(p1) * 2).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2u(p1) * 2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype((2 * CovSA2l(p1)).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((2 * CovSA2u(p1)).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((2 * CovT2l(p1)).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((2 * CovT2u(p1)).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  Eigen3::hermitian_adapter<I2, triangle_type::lower> sai2 {I2::Identity()};
  ...
  static_assert(hermitian_adapter_concept<decltype((CovSA2l(p1) / 0.5).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype((CovSA2u(p1) / 0.5).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype((CovT2l(p1) / 0.5).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype((CovT2u(p1) / 0.5).get_triangular_nested_matrix()), triangle_type::upper>);
...
TEST(covariance_tests, Covariance_scale)
{
  ...
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype(scale(CovT2l(p1), 2).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype(scale(CovT2u(p1), 2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype(inverse_scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype(inverse_scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype(inverse_scale(CovT2l(p1), 2).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype(inverse_scale(CovT2u(p1), 2).get_triangular_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA2l(p1), a1).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA2u(p1), a1).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype(scale(CovT2l(p1), a1).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype(scale(CovT2u(p1), a1).get_triangular_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype(scale(CovD2 {1, 2}, a1).get_self_adjoint_nested_matrix()), triangle_type::lower>);

  // Rank-sufficient case
  using CovSA3l = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, hermitian_adapter<M3, triangle_type::lower>>;
  using CovSA3u = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, hermitian_adapter<M3, triangle_type::upper>>;
  using CovT3l = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, triangular_adapter<M3, triangle_type::lower>>;
  using CovT3u = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, triangular_adapter<M3, triangle_type::upper>>;
  using CovD3 = Covariance<std::tuple<angle::Radians, Axis, angle::Radians>, to_diagonal_adapter<eigen_matrix_t<double, 3, 1>>>;
  Mat3 q1 {4, 2, 2,
           2, 5, 3,
           2, 3, 6};
  ...
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA3l(q1), b1).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  static_assert(hermitian_adapter_concept<decltype(scale(CovSA3u(q1), b1).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  static_assert(triangular_matrix<decltype(scale(CovT3l(q1), b1).get_triangular_nested_matrix()), triangle_type::lower>);
  static_assert(triangular_matrix<decltype(scale(CovT3u(q1), b1).get_triangular_nested_matrix()), triangle_type::upper>);
  static_assert(hermitian_adapter_concept<decltype(scale(CovD3 {4, 5, 6}, b1).get_self_adjoint_nested_matrix()), triangle_type::lower>);
}
...
TEST(covariance_tests, TypedMatrix_mult_Covariance)
{
  ...
  static_assert(hermitian_adapter_concept<decltype((mati2 * covSA2l).get_self_adjoint_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(hermitian_adapter_concept<decltype((mati2 * covSA2u).get_self_adjoint_nested_matrix()), triangle_type::upper>);
  ...
  static_assert(triangular_matrix<decltype((mati2 * covT2l).get_triangular_nested_matrix()), triangle_type::lower>);
  ...
  static_assert(triangular_matrix<decltype((mati2 * covT2u).get_triangular_nested_matrix()), triangle_type::upper>);
