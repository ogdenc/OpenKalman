...
TEST(covariance_tests, Covariance_addition)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovD2 {9, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovD2 {9, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovD2 {9, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovD2 {9, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covi2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covi2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covi2 + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covi2 + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covz2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covz2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_addition_mixed)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovT2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovT2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_subtraction)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covz2 - CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covz2 - CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covz2 - CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covz2 - CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(diagonal_matrix<decltype((covz2 - CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_mult_covariance)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covi2 * CovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covi2 * CovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((covi2 * SqCovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((covi2 * SqCovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_mult_scalar)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l(p1) * 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u(p1) * 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((2 * CovSA2l(p1)).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((2 * CovSA2u(p1)).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype((CovSA2l(p1) / 0.5).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype((CovSA2u(p1) / 0.5).get_self_adjoint_nested_matrix())>);
...
TEST(covariance_tests, Covariance_scale)
{
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype(scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(inverse_scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype(inverse_scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(scale(CovSA2l(p1), a1).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype(scale(CovSA2u(p1), a1).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(scale(CovD2 {1, 2}, a1).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(scale(CovSA3l(q1), b1).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_self_adjoint_matrix<decltype(scale(CovSA3u(q1), b1).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_self_adjoint_matrix<decltype(scale(CovD3 {4, 5, 6}, b1).get_self_adjoint_nested_matrix())>);
}
