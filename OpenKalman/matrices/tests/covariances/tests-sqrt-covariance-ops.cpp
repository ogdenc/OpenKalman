...
TEST(covariance_tests, SquareRootCovariance_mult_TypedMatrix)
{
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(sqCovT2l * mati2x)>, C>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(sqCovT2l * mati2x)>, Cx>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(sqCovT2u * mati2x)>, C>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(sqCovT2u * mati2x)>, Cx>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(sqCovD2 * mati2x)>, C>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(sqCovD2 * mati2x)>, Cx>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(sqcovi2 * mati2x)>, C>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(sqcovi2 * mati2x)>, Cx>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(sqcovz2 * mati2x)>, C>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(sqcovz2 * mati2x)>, Cx>);
}
...
TEST(covariance_tests, TypedMatrix_mult_SquareRootCovariance)
{
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(mati2x * sqCovT2l)>, Cx>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(mati2x * sqCovT2l)>, C>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(mati2x * sqCovT2u)>, Cx>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(mati2x * sqCovT2u)>, C>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(mati2x * sqCovD2)>, Cx>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(mati2x * sqCovD2)>, C>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(mati2x * sqcovi2)>, Cx>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(mati2x * sqcovi2)>, C>);
  ...
  static_assert(equivalent_to<row_coefficient_types_of_t<decltype(mati2x * sqcovz2)>, Cx>);
  static_assert(equivalent_to<column_coefficient_types_of_t<decltype(mati2x * sqcovz2)>, C>);
}
