...
using MC = Mean<FixedDescriptor<Polar<>, Axis>, eigen_matrix_t<double, 3, 1>>;
...
TEST(transformations, finite_diff_sum_of_squares_3D)
{
...
TEST(transformations, finite_diff_time_of_arrival_2D)
{
...
TEST(transformations, finite_diff_time_of_arrival_3D)
{
...
TEST(transformations, finite_diff_radar)
{
  auto f = radar;
...
TEST(transformations, finite_diff_radarP)
{
  auto f = radarP;
...
TEST(transformations, finite_diff_Cartesian2polar)
{
...
TEST(transformations, finite_diff_Cylindrical2spherical)
{
