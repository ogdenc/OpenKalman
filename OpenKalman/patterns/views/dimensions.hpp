...
/**
 * \file
 * \brief Definition of \ref patterns::views::dimensions.
 */

#ifndef OPENKALMAN_PATTERNS_VIEWS_DIMENSIONS_HPP
#define OPENKALMAN_PATTERNS_VIEWS_DIMENSIONS_HPP
...
{
  template<typename T>
  struct tuple_size<OpenKalman::patterns::dimensions_tuple_view<T>>
    : OpenKalman::collections::size_of<T> {};


  template<std::size_t i, typename T>
  struct tuple_element<i, OpenKalman::patterns::dimensions_tuple_view<T>>
    : OpenKalman::patterns::dimension_of<OpenKalman::collections::collection_element_t<i, T>> {};
}
