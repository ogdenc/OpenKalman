...
{
  /**
   * \brief An atomic \ref patterns::descriptor reflecting polar coordinates.
...
namespace OpenKalman::interface
{
  ...
  struct pattern_descriptor_traits<patterns::Polar<patterns::Distance, patterns::Angle<Min, Max>>>
    : detail::PolarBase<patterns::Polar<patterns::Distance, patterns::Angle<Min, Max>>, Min, Max, 0, 1,  0, 1, 2>
  {};
   ...
   */
  template<typename Min, typename Max>
  struct pattern_descriptor_traits<patterns::Polar<patterns::Angle<Min, Max>, patterns::Distance>>
    : detail::PolarBase<patterns::Polar<patterns::Angle<Min, Max>, patterns::Distance>, Min, Max, 1, 0,  2, 0, 1>
  {};
...
namespace std
{
  ...
  struct common_type<
      OpenKalman::patterns::Polar<OpenKalman::patterns::Distance, OpenKalman::patterns::Angle<Min1, Max1>>,
      OpenKalman::patterns::Polar<OpenKalman::patterns::Distance, OpenKalman::patterns::Angle<Min2, Max2>>>
    : std::conditional<
  ...
  template<typename Min1, typename Max1, typename Min2, typename Max2>
  struct common_type<
      OpenKalman::patterns::Polar<OpenKalman::patterns::Angle<Min1, Max1>, OpenKalman::patterns::Distance>,
      OpenKalman::patterns::Polar<OpenKalman::patterns::Angle<Min2, Max2>, OpenKalman::patterns::Distance>>
    : std::conditional<
      OpenKalman::values::fixed_value_of_v<Min1> == OpenKalman::values::fixed_value_of_v<Min2> and
          OpenKalman::values::fixed_value_of_v<Max1> == OpenKalman::values::fixed_value_of_v<Max2>,
      OpenKalman::patterns::Polar<OpenKalman::patterns::Angle<Min1, Max1>, OpenKalman::patterns::Distance>,
  ...
  struct common_type<OpenKalman::patterns::Polar<C1, C2>, OpenKalman::patterns::Any<Scalar>>
    : common_type<OpenKalman::patterns::Any<Scalar>, OpenKalman::patterns::Polar<C1, C2>> {};


  template<typename C1, typename C2, typename T>
  struct common_type<OpenKalman::patterns::Polar<C1, C2>, T>
    : std::conditional_t<
