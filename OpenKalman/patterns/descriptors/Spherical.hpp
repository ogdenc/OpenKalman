...
{
  /**
   * \brief A \ref patterns::descriptor reflecting spherical coordinates according to the ISO 80000-2:2019 convention.
...
namespace OpenKalman::interface
{
  namespace detail
  {
    ...
    public:
      ...
      {
        constexpr auto a = patterns::internal::get_descriptor_hash_code(patterns::Angle<Min, Max>{});
        constexpr auto b = patterns::internal::get_descriptor_hash_code(patterns::Inclination<Down>{});
    ...
    private:
      ...
      struct calc_theta
      {
        ...
        {
          return (R{down} / stdex::numbers::pi_v<R>) * (h == R{0} ? std::move(h) : values::acos(z/h));
        }
      };
  ...
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Distance, patterns::Inclination<Down>, patterns::Angle<Min, Max>>>
    : detail::SphericalBase<patterns::Spherical<patterns::Distance, patterns::Inclination<Down>, patterns::Angle<Min, Max>>, Min, Max, Down, 0, 2, 1>
  {};
  ...
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Distance, patterns::Angle<Min, Max>, patterns::Inclination<Down>>>
    : detail::SphericalBase<patterns::Spherical<patterns::Distance, patterns::Angle<Min, Max>, patterns::Inclination<Down>>, Min, Max, Down, 0, 1, 2>
  {};
   ...
   */
  template<typename Min, typename Max, typename Down>
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Angle<Min, Max>, patterns::Distance, patterns::Inclination<Down>>>
    : detail::SphericalBase<patterns::Spherical<patterns::Angle<Min, Max>, patterns::Distance, patterns::Inclination<Down>>, Min, Max, Down, 1, 0, 2>
  {};
   ...
   */
  template<typename Down, typename Min, typename Max>
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Inclination<Down>, patterns::Distance, patterns::Angle<Min, Max>>>
    : detail::SphericalBase<patterns::Spherical<patterns::Inclination<Down>, patterns::Distance, patterns::Angle<Min, Max>>, Min, Max, Down, 1, 2, 0>
  {};
   ...
   */
  template<typename Min, typename Max, typename Down>
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Angle<Min, Max>, patterns::Inclination<Down>, patterns::Distance>>
    : detail::SphericalBase<patterns::Spherical<patterns::Angle<Min, Max>, patterns::Inclination<Down>, patterns::Distance>, Min, Max, Down, 2, 0, 1>
  {};
   ...
   */
  template<typename Down, typename Min, typename Max>
  struct pattern_descriptor_traits<patterns::Spherical<patterns::Inclination<Down>, patterns::Angle<Min, Max>, patterns::Distance>>
    : detail::SphericalBase<patterns::Spherical<patterns::Inclination<Down>, patterns::Angle<Min, Max>, patterns::Distance>, Min, Max, Down, 2, 1, 0>
  {};
...
namespace std
{
  ...
  struct common_type<
      OpenKalman::patterns::Spherical<
        OpenKalman::patterns::Distance,
        OpenKalman::patterns::Inclination<Down1>,
        OpenKalman::patterns::Angle<Min1, Max1>>,
      OpenKalman::patterns::Spherical<
        OpenKalman::patterns::Distance,
        OpenKalman::patterns::Inclination<Down2>,
        OpenKalman::patterns::Angle<Min2, Max2>>>
    : std::conditional<
  ...
  struct common_type<OpenKalman::patterns::Spherical<C1, C2, C3>, OpenKalman::patterns::Any<Scalar>>
    : common_type<OpenKalman::patterns::Any<Scalar>, OpenKalman::patterns::Spherical<C1, C2, C3>> {};


  template<typename C1, typename C2, typename C3, typename T>
  struct common_type<OpenKalman::patterns::Spherical<C1, C2, C3>, T>
    : std::conditional_t<
