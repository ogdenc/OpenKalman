...
/**
 * \file
 * \brief Tests for patterns::Dimensions
 */
...
TEST(patterns, Dimensions_fixed)
{
...
TEST(patterns, Dimensions_dynamic)
{
  using D = Dimensions<>;
...
TEST(patterns, Dimensions_assignment)
{
...
TEST(patterns, Dimensions_transformations)
{
