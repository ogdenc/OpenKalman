...
TEST(patterns, common_descriptor_type)
{
  ...
  static_assert(stdex::same_as<common_descriptor_type_t<stdex::ranges::repeat_view<Dimensions<>, std::size_t>>, Dimensions<1>>);
  static_assert(stdex::same_as<common_descriptor_type_t<stdex::ranges::repeat_view<Dimensions<1>, std::size_t>>, Dimensions<1>>);
  static_assert(stdex::same_as<common_descriptor_type_t<stdex::ranges::repeat_view<Polar<>, std::size_t>>, Polar<>>);
...
TEST(patterns, uniform_pattern_type)
{
  ...
  static_assert(stdex::same_as<uniform_pattern_type_t<stdex::ranges::repeat_view<angle::Radians, std::size_t>>, angle::Radians>);
  static_assert(stdex::same_as<uniform_pattern_type_t<stdex::ranges::repeat_view<angle::Radians>>, angle::Radians>);
}


#include "patterns/concepts/uniform_pattern.hpp"

TEST(patterns, uniform_pattern)
{
  static_assert(uniform_pattern<Dimensions<5>>);
  static_assert(uniform_pattern<Dimensions<5>, applicability::permitted>);
  static_assert(uniform_pattern<Dimensions<0>>);
  static_assert(uniform_pattern<Dimensions<0>, applicability::permitted>);
  static_assert(uniform_pattern<std::tuple<Dimensions<2>, Dimensions<5>>>);
  static_assert(uniform_pattern<Angle<>>);
  static_assert(not uniform_pattern<Polar<>, applicability::permitted>);
  static_assert(not uniform_pattern<Spherical<>, applicability::permitted>);
  ...
  static_assert(not uniform_pattern<std::tuple<Axis, Distance, Angle<>, Inclination<>>, applicability::permitted>);
  static_assert(not uniform_pattern<std::tuple<Polar<>, Polar<>>, applicability::permitted>);
  static_assert(not uniform_pattern<std::tuple<Axis, angle::Radians>, applicability::permitted>);
  static_assert(not uniform_pattern<std::tuple<Axis, Any<>, Angle<>, Inclination<>>, applicability::permitted>);

  static_assert(uniform_pattern<std::vector<Distance>>);
  static_assert(uniform_pattern<std::array<Angle<>, 5>>);

  static_assert(uniform_pattern<std::tuple<Any<>, Any<>, Any<>, Distance>, applicability::permitted>);
  static_assert(not uniform_pattern<std::tuple<Any<>, Any<>, Any<>, Distance>>);
  static_assert(uniform_pattern<std::tuple<Any<>, Distance, Any<>, Any<>, Distance>, applicability::permitted>);
  static_assert(not uniform_pattern<std::tuple<Any<>, Distance, Any<>, Any<>, Distance>>);
  static_assert(not uniform_pattern<std::tuple<Any<>, Angle<>, Any<>, Any<>, Distance>, applicability::permitted>);
  static_assert(uniform_pattern<std::vector<Any<>>, applicability::permitted>);
  static_assert(not uniform_pattern<std::vector<Any<>>>);
  static_assert(not uniform_pattern<std::tuple<Dimensions<2>, Distance, Dimensions<5>>, applicability::permitted>);
}


#include "patterns/functions/get_uniform_pattern_component.hpp"
#include "patterns/functions/compare.hpp"

TEST(patterns, get_uniform_pattern_component)
{
  static_assert(compare(get_uniform_pattern_component(Dimensions<10>{}).value(), Axis{}));
  static_assert(compare(get_uniform_pattern_component(std::tuple<Distance, Distance, Distance>{}).value(), Distance{}));
  ...
  static_assert(compare(get_uniform_pattern_component(stdex::ranges::views::repeat(Dimensions<1>{}, 100U)).value(), Dimensions<1>{}));
...
#include "patterns/functions/is_uniform_pattern_component_of.hpp"

TEST(patterns, is_uniform_pattern_component_of)
{
  // fixed:
  static_assert(is_uniform_pattern_component_of(Dimensions<1>{}, Dimensions<0>{}));
  ...
  static_assert(is_uniform_pattern_component_of(Distance{}, Distance{}));
  static_assert(is_uniform_pattern_component_of(Distance{}, std::tuple{Distance{}}));
  ...
  EXPECT_TRUE(is_uniform_pattern_component_of(std::vector{Any{Axis{}}, Any{Dimensions<0>{}}}, Any{Dimensions<0>{}}));
  ...
  EXPECT_TRUE(is_uniform_pattern_component_of(Any{Dimensions<1>{}}, Any{Dimensions<0>{}}));
