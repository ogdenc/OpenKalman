...
#include "patterns/functions/pattern_collection_of_diagonal.hpp"

TEST(patterns, pattern_collection_of_diagonal)
{
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<3>{}, Dimensions<3>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<3>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<2>{}, Dimensions<3>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<2>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<3>{}, Dimensions<2>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<2>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<0>{}, Dimensions<3>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<0>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<3>{}, Dimensions<0>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<0>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{Dimensions<3>{}})),
    std::tuple<Dimensions<1>>>);
  static_assert(collection_compares_with<
    decltype(pattern_collection_of_diagonal(std::tuple{})),
    std::tuple<>>);

  EXPECT_TRUE(compare_pattern_collections(pattern_collection_of_diagonal(
...
#include "patterns/functions/to_diagonal_pattern_collection.hpp"

TEST(patterns, to_diagonal_pattern_collection)
{
  static_assert(collection_compares_with<
    decltype(to_diagonal_pattern_collection(std::tuple{Dimensions<3>{}, Angle{}, Polar{}})),
    std::tuple<Dimensions<3>, Dimensions<3>, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(to_diagonal_pattern_collection(std::tuple{Distance{}, Angle{}, Polar{}})),
    std::tuple<Distance, Distance, Angle<>, Polar<>>>);
  static_assert(collection_compares_with<
    decltype(to_diagonal_pattern_collection(std::tuple{})),
    std::tuple<>>);
}
