...
TEST(patterns, Any)
{
  ...
  EXPECT_NE(OpenKalman::patterns::internal::get_descriptor_hash_code(angle::Radians{}), OpenKalman::patterns::internal::get_descriptor_hash_code(angle::Degrees{}));
  EXPECT_NE(OpenKalman::patterns::internal::get_descriptor_hash_code(Any{angle::Radians{}}), OpenKalman::patterns::internal::get_descriptor_hash_code(Any{angle::Degrees{}}));
  EXPECT_NE(OpenKalman::patterns::internal::get_descriptor_hash_code(Any{inclination::Radians{}}), OpenKalman::patterns::internal::get_descriptor_hash_code(Any{inclination::Degrees{}}));
  EXPECT_NE(OpenKalman::patterns::internal::get_descriptor_hash_code(Any{angle::Radians{}}), OpenKalman::patterns::internal::get_descriptor_hash_code(Any{Polar{}}));
  ...
  EXPECT_NEAR(to_stat_space(crefa, std::array{-13./12})[1U], -0.5, 1e-6);
  EXPECT_NEAR(from_stat_space(crefa, std::array{0.5, -sqrt3_2})[0U], 5./6, 1e-6);
  EXPECT_NEAR(wrap(crefa, std::array{-0.2})[0U], 0.8, 1e-6);
}


TEST(patterns, descriptor_combinations)
{
  ...
  static_assert(std::is_same_v<std::common_type_t<values::fixed_value<std::size_t, 2>, std::integral_constant<std::size_t, 3>>, std::size_t>);
  static_assert(std::is_same_v<std::common_type_t<std::integral_constant<std::size_t, 2>, values::fixed_value<std::size_t, 3>>, std::size_t>);
  static_assert(std::is_same_v<std::common_type_t<values::fixed_value<std::size_t, 2>, values::fixed_value<std::size_t, 3>>, std::size_t>);
