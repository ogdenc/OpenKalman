...
namespace OpenKalman::patterns
{
   ...
   * \param stat_data_view A range within a data object corresponding to \ref patterns::descriptor "descriptor" t.
   */
   ...
   * \param stat_data_view A range within a data object corresponding to patterns::descriptor_collection "descriptor_collection" t
   */
#ifdef __cpp_concepts
