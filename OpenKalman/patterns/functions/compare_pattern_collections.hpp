...
/**
 * \file
 * \brief Definition of \ref patterns::compare_pattern_collections.
 */

#ifndef OPENKALMAN_PATTERNS_COMPARE_PATTERN_COLLECTIONS_HPP
#define OPENKALMAN_PATTERNS_COMPARE_PATTERN_COLLECTIONS_HPP
...
constexpr auto
  ...
  {
    if constexpr (collection_compares_with<A, B, comp, applicability::guaranteed>)
    {
      return std::true_type {};
    }
    else if constexpr (not collection_compares_with<A, B, comp, applicability::permitted> or
