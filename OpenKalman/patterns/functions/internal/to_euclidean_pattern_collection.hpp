 ...
 * \file
 * \internal
 * \brief Definition for \ref patterns::to_euclidean_pattern_collection.
 */
...
{
  /**
   * \brief Convert a \ref pattern_collection to its equivalent-sized \ref patterns::euclidean_pattern_collection.
   */
