...
/**
 * \file
 * \brief Definition for \ref patterns::euclidean_pattern_collection.
 */
...
namespace OpenKalman::patterns
{
  ...
  namespace detail
  {
    ...
    template<typename T>
    struct is_euclidean_descriptor_range<T, std::enable_if_t<euclidean_pattern<stdex::ranges::range_value_t<T>>>>
      : std::true_type {};
  }
#endif
