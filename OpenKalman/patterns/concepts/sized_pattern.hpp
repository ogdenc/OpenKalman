...
/**
 * \file
 * \brief Definition for \ref patterns::sized_pattern.
 */

#ifndef OPENKALMAN_COORDINATE_SIZED_PATTERN_HPP
#define OPENKALMAN_COORDINATE_SIZED_PATTERN_HPP
...
namespace OpenKalman::patterns
{
  ...
  concept sized_pattern =
#else
  inline constexpr bool sized_pattern =
#endif
