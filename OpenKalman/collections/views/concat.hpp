...
namespace OpenKalman::collections
{
  ...
  /**
   * \brief A view to a concatenation of some number of other \ref uniformly_gettable object
   * \details This is similar to std::tuple_cat, but it allows for concatenation of any \ref uniformly_gettable object.
   * \tparam Ts A set of base \ref uniformly_gettable objects
   */
