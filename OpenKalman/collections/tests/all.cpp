...
TEST(collections, all_view_range)
{
  ...
  static_assert(stdex::ranges::range<views::all_t<std::vector<int>&>>);
  static_assert(stdex::ranges::range<views::all_t<std::vector<int>>>);
  static_assert(stdex::ranges::view<views::all_t<std::vector<double>>>);
  static_assert(stdex::ranges::view<views::all_t<std::vector<int>>>);
  static_assert(stdex::ranges::view<views::all_t<std::vector<int>&>>);
  static_assert(stdex::ranges::view<views::all_t<const std::vector<int>&>>);

  static_assert(sized<views::all_t<std::vector<double>>>);
  static_assert(sized<views::all_t<std::vector<int>>>);
  static_assert(sized<views::all_t<std::vector<int>&>>);
  ...
  static_assert(stdex::ranges::random_access_range<decltype(views::all(v1))>);
  ...
  EXPECT_EQ(*stdex::ranges::begin(views::all(v1)), 4);
  EXPECT_EQ(*--stdex::ranges::end(views::all(v1)), 8);
  EXPECT_EQ(stdex::ranges::size(views::all(v1)), 5);
  ...
  EXPECT_EQ(*stdex::ranges::cbegin(views::all(v1)), 4);
  EXPECT_EQ(*--stdex::ranges::cend(views::all(v1)), 8);
  ...
  EXPECT_EQ((v1 | views::all | stdex::ranges::views::transform([](auto a){return a*a;}))[1u], 25);
  EXPECT_EQ((v1 | views::all | stdex::ranges::views::reverse)[1u], 7);
  EXPECT_EQ((v1 | views::all | stdex::ranges::views::reverse | stdex::ranges::views::transform([](auto a){return a*a;}))[1u], 49);
}
...
TEST(collections, all_view_cpp_array)
{
  ...
  //static_assert(stdex::same_as<views::all_t<int(&)[5]>, from_range<int (&)[5]>>);
  //static_assert(stdex::same_as<views::all_t<const int(&)[5]>, from_range<const int(&)[5]>>);
  //static_assert(stdex::same_as<views::all_t<decltype((a1))>, from_range<const int(&)[5]>>);
  static_assert(stdex::ranges::range<views::all_t<int(&)[5]>>);
  static_assert(std::tuple_size_v<views::all_t<int(&)[5]>> == 5);
  static_assert(std::tuple_size_v<stdex::ranges::views::all_t<views::all_t<int(&)[5]>>> == 5);
  static_assert(std::tuple_size_v<views::all_t<const int(&)[5]>> == 5);
  static_assert(std::tuple_size_v<stdex::ranges::views::all_t<views::all_t<const int(&)[5]>>> == 5);
  static_assert(std::tuple_size_v<views::all_t<decltype(stdex::ranges::views::reverse(views::all(a1)))>> == 5);
  static_assert(stdex::same_as<std::tuple_element_t<1, views::all_t<int(&)[5]>>, int>);
  static_assert(stdex::same_as<std::tuple_element_t<1, stdex::ranges::views::all_t<views::all_t<int(&)[5]>>>, int>);
  static_assert(stdex::same_as<std::tuple_element_t<2, views::all_t<const int(&)[5]>>, int>);
  static_assert(stdex::same_as<std::tuple_element_t<2, stdex::ranges::views::all_t<views::all_t<const int(&)[5]>>>, int>);
  static_assert(views::all(a1).template get<0>() == 1);
  static_assert(views::all(a1).template get<4>() == 5);
  static_assert(get<0>(views::all(a1)) == 1);
  static_assert(get<4>(views::all(a1)) == 5);
  ...
  static_assert(*stdex::ranges::begin(views::all(a1)) == 1);
  static_assert(*(stdex::ranges::end(views::all(a1)) - 1) == 5);
  static_assert(*stdex::ranges::cbegin(views::all(a1)) == 1);
  static_assert(*(stdex::ranges::cend(views::all(a1)) - 1) == 5);
  static_assert(stdex::ranges::size(views::all(a1)) == 5);
  static_assert(stdex::ranges::begin(views::all(a1))[2] == 3);
...
TEST(collections, all_view_tuple_like_range)
{
  ...
  static_assert(stdex::ranges::view<views::all_t<std::array<double, 4>>>);
  static_assert(stdex::ranges::view<views::all_t<std::array<int, 7>>>);

  static_assert(sized<views::all_t<std::array<double, 4>>>);
  static_assert(sized<views::all_t<std::array<int, 7>>>);
  static_assert(sized<views::all_t<const std::array<int, 7>&>>);
  ...
  static_assert(stdex::same_as<views::all_t<std::array<int, 5>>, from_range<std::array<int, 5>>>);
  static_assert(stdex::same_as<views::all_t<std::array<double, 5>>, from_range<std::array<double, 5>>>);
  static_assert(std::tuple_size_v<views::all_t<std::array<int, 5>>> == 5);
}
