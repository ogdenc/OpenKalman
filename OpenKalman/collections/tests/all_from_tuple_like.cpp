...
TEST(collections, all_view_tuple_like)
{
  ...
  EXPECT_EQ((t1 | views::all | stdcompat::ranges::views::reverse | stdcompat::ranges::views::transform([](auto a){return a*a;}))[1u], 16);
  ...
  static_assert(uniformly_gettable<decltype(t1 | views::all | stdcompat::ranges::views::transform(std::negate{}) | views::all)>);
