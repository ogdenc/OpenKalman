...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct native_traits<OpenKalman::Mean<TypedIndex, NestedMatrix>, std::enable_if_t<
    ...
    : Eigen::internal::traits<std::decay_t<NestedMatrix>>
  {
    ...
    enum
    {
      Flags = OpenKalman::euclidean_vector_space_descriptor<TypedIndex> ? BaseFlags : BaseFlags & ~Eigen::LvalueBit,
    };
  };
