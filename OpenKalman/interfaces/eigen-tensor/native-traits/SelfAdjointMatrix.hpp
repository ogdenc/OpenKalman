 ...
 * \internal
 * \file
 * \brief Native Eigen3 tensor traits for Eigen3 general \ref SelfAdjointMatrix
 */
...
namespace OpenKalman::Eigen3::internal
{
    ...
    : Eigen::internal::traits<std::decay_t<NestedMatrix>>
  {
    ...
    enum
    {
      Flags = Base::Flags & ~(OpenKalman::complex_number<typename Base::Scalar> ? Eigen::LvalueBit : 0x0),
    };
  };
