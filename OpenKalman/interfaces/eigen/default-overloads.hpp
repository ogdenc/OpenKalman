...
namespace OpenKalman
{
  ...
  template<static_vector_space_descriptor RowCoefficients, static_vector_space_descriptor ColumnCoefficients = RowCoefficients, scalar_type ... Args>
   ...
   */
#ifdef __cpp_concepts
  template<scalar_type Scalar, static_vector_space_descriptor RowCoefficients,
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, scalar_type ... Args> requires
   ...
   */
#ifdef __cpp_concepts
  template<scalar_type Scalar, static_vector_space_descriptor StaticDescriptor, std::size_t cols = 1>
#else
  template<typename Scalar, typename StaticDescriptor, std::size_t cols = 1, std::enable_if_t<
  scalar_type<Scalar> and static_vector_space_descriptor<StaticDescriptor>, int> = 0>
#endif
  auto make_mean()
  {
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type, scalar_type ... Args> requires
  ...
  template<typename StaticDescriptor, TriangleType triangle_type, typename ... Args, std::enable_if_t<
    static_vector_space_descriptor<StaticDescriptor> and (scalar_type<Args> and ...) and
    (triangle_type == TriangleType::lower or triangle_type == TriangleType::upper) and
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type, scalar_type Scalar = double>
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, scalar_type Scalar = double>
#else
  template<typename StaticDescriptor, typename Scalar = double, std::enable_if_t<
    static_vector_space_descriptor<StaticDescriptor> and scalar_type<Scalar>, int> = 0>
#endif
  auto make_covariance()
  {
    using Mat = Eigen3::eigen_matrix_t<Scalar, dimension_size_of_v<StaticDescriptor>, dimension_size_of_v<StaticDescriptor>>;
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type = TriangleType::lower, scalar_type ... Args>
  ...
  template<typename StaticDescriptor, TriangleType triangle_type = TriangleType::lower, typename ... Args,
    std::enable_if_t<static_vector_space_descriptor<StaticDescriptor> and (scalar_type<Args> and ...) and
      (triangle_type == TriangleType::lower or triangle_type == TriangleType::upper) and
      (sizeof...(Args) > 0) and (sizeof...(Args) == dimension_size_of_v<StaticDescriptor> * dimension_size_of_v<StaticDescriptor>), int> = 0>
#endif
   ...
   */
#ifdef __cpp_concepts
  template<static_vector_space_descriptor StaticDescriptor, TriangleType triangle_type = TriangleType::lower, scalar_type Scalar = double>
  requires (triangle_type == TriangleType::lower or triangle_type == TriangleType::upper)
#else
