...
TEST(eigen3, Eigen_CwiseBinaryOp_scalar_product_op)
{
  ...
  static_assert(constant_matrix<Eigen::CwiseBinaryOp<Eigen::internal::scalar_product_op<double, double>, M11, M11>, ConstantType::dynamic_constant>);
  static_assert(constant_matrix<Eigen::CwiseBinaryOp<Eigen::internal::scalar_product_op<double, double>, M11::ConstantReturnType, M11>, ConstantType::dynamic_constant>);
  static_assert(constant_matrix<Eigen::CwiseBinaryOp<Eigen::internal::scalar_product_op<double, double>, M11, M11::ConstantReturnType>, ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_CwiseBinaryOp_scalar_quotient_op)
{
  ...
  static_assert(not constant_matrix<decltype(std::declval<C21_2>() / std::declval<Z21>()), ConstantType::static_constant>); // divide by zero
  static_assert(constant_matrix<decltype(std::declval<C21_2>() / std::declval<Z21>()), ConstantType::dynamic_constant>); // divide by zero, but determined at runtime
