...
{
  static_assert(constant_matrix<decltype(cxx_22_m2.colwise().lpNorm<0>()), ConstantType::dynamic_constant>);
  ...
  static_assert(constant_matrix<decltype(cd2x_2_m2.rowwise().lpNorm<0>()), ConstantType::dynamic_constant>);
  EXPECT_EQ(constant_coefficient{cd2x_2_m2.rowwise().lpNorm<0>()}(), INFINITY);
  EXPECT_EQ(cd2x_2_m2.rowwise().lpNorm<0>()(0,0), INFINITY);
  static_assert(constant_matrix<decltype(cdx2_2_m2.colwise().lpNorm<0>()), ConstantType::dynamic_constant>);
  EXPECT_EQ(constant_coefficient{cdx2_2_m2.colwise().lpNorm<0>()}(), INFINITY);
  EXPECT_EQ(cdx2_2_m2.colwise().lpNorm<0>()(0,0), INFINITY);
  static_assert(constant_matrix<decltype(cdxx_22_m2.colwise().lpNorm<0>()), ConstantType::dynamic_constant>);
  EXPECT_EQ(constant_coefficient{cdxx_22_m2.colwise().lpNorm<0>()}(), INFINITY);
  EXPECT_EQ(cdxx_22_m2.colwise().lpNorm<0>()(0,0), INFINITY);
  static_assert(constant_matrix<decltype(cdxx_22_m2.rowwise().lpNorm<0>()), ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_PartialReduxExpr_lpNorm1)
{
  ...
  static_assert(constant_matrix<decltype(cdxx22_33_m2.colwise().lpNorm<1>()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cdxx22_33_m2.rowwise().lpNorm<1>()), ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_PartialReduxExpr_lpNorm2)
{
  ...
  static_assert(constant_matrix<decltype(cdxx22_33_m2.colwise().lpNorm<2>()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cdxx22_33_m2.rowwise().lpNorm<2>()), ConstantType::dynamic_constant>);
  ...
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.colwise().lpNorm<2>()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.rowwise().lpNorm<2>()), ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_PartialReduxExpr_lpNorm3)
{
  ...
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.colwise().lpNorm<3>()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.rowwise().lpNorm<3>()), ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_PartialReduxExpr_stableNorm)
{
  ...
  static_assert(constant_matrix<decltype(cdxx22_33_m2.colwise().stableNorm()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cdxx22_33_m2.rowwise().stableNorm()), ConstantType::dynamic_constant>);
  ...
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.colwise().stableNorm()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.rowwise().stableNorm()), ConstantType::dynamic_constant>);
...
TEST(eigen3, Eigen_PartialReduxExpr_sum)
{
  ...
  static_assert(constant_matrix<decltype(cdxx22_33_m2.colwise().sum()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cdxx22_33_m2.rowwise().sum()), ConstantType::dynamic_constant>);
  EXPECT_EQ(constant_coefficient{cdxx22_33_m2.colwise().sum()}(), -6);
  EXPECT_EQ(constant_coefficient{cdxx22_33_m2.rowwise().sum()}(), -6);
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.colwise().sum()), ConstantType::dynamic_constant>);
  static_assert(constant_matrix<decltype(cd33xx_22_m2a.rowwise().sum()), ConstantType::dynamic_constant>);
  ...
  static_assert(constant_matrix<decltype(cxx_22_m2.cwiseAbs2().rowwise().sum()), ConstantType::dynamic_constant>);
