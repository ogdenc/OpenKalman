...
TEST(eigen3, Eigen_PartialReduxExpr_other)
{
  ...
  static_assert(not constant_matrix<decltype(cd02_2_m2.colwise().count()), ConstantType::static_constant>);
  ...
  static_assert(not constant_matrix<decltype(cd20_2_m2.rowwise().count()), ConstantType::static_constant>);
