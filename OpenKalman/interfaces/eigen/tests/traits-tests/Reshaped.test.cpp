...
TEST(eigen3, Eigen_Reshaped)
{
  ...
  static_assert(constant_diagonal_matrix<Eigen::Reshaped<Cd22_2, Eigen::Dynamic, Eigen::Dynamic>, ConstantType::static_constant>);
  static_assert(not constant_diagonal_matrix<Eigen::Reshaped<Cd22_2, Eigen::Dynamic, Eigen::Dynamic>>);
  static_assert(constant_diagonal_matrix<Eigen::Reshaped<Cdxx_2, Eigen::Dynamic, Eigen::Dynamic>, ConstantType::static_constant>);
  static_assert(not constant_diagonal_matrix<Eigen::Reshaped<Cdxx_2, Eigen::Dynamic, Eigen::Dynamic>>);
  static_assert(constant_diagonal_matrix<Eigen::Reshaped<Cdxx_2, 2, Eigen::Dynamic>, ConstantType::static_constant>);
  static_assert(not constant_diagonal_matrix<Eigen::Reshaped<Cdxx_2, 2, Eigen::Dynamic>>);
  static_assert(constant_diagonal_matrix<Eigen::Reshaped<Cdxx_2, Eigen::Dynamic, 2>, ConstantType::static_constant>);
  ...
  static_assert(triangular_matrix<Eigen::Reshaped<Tlv2x, Eigen::Dynamic, 2>, TriangleType::lower>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tlvx2, Eigen::Dynamic, 2>, TriangleType::lower>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tlvx2, 2, Eigen::Dynamic>, TriangleType::lower>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tlvxx, 2, 2>, TriangleType::lower>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tlvxx, Eigen::Dynamic, 2>>);
  ...
  static_assert(triangular_matrix<Eigen::Reshaped<Tuv2x, Eigen::Dynamic, 2>, TriangleType::upper>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tuvx2, Eigen::Dynamic, 2>, TriangleType::upper>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tuvx2, 2, Eigen::Dynamic>, TriangleType::upper>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tuvxx, 2, 2>, TriangleType::upper>);
  static_assert(triangular_matrix<Eigen::Reshaped<Tuvxx, Eigen::Dynamic, 2>>);
