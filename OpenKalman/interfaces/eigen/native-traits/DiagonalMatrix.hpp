 ...
 * \internal
 * \file
 * \brief Native Eigen3 traits for Eigen3 general \ref DiagonalMatrix
 */
...
namespace OpenKalman::Eigen3::internal
{
  ...
  struct native_traits<OpenKalman::DiagonalMatrix<NestedMatrix>, std::enable_if_t<OpenKalman::Eigen3::eigen_general<NestedMatrix>>>
#endif
