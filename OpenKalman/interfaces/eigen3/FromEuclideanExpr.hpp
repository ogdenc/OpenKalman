...
#else
    template<typename Arg, std::enable_if_t<is_FromEuclideanExpr_v < Arg> or is_Eigen_matrix_v<Arg>, int> = 0>
#endif
...
namespace OpenKalman
{
  ...
  struct MatrixTraits<Eigen3::FromEuclideanExpr<Coeffs, ArgType>>
  {
    ...
    using MatrixBaseType = Eigen3::internal::EigenMatrixBase<Derived, Eigen3::FromEuclideanExpr<Coeffs, ArgType>>;
    ...
    template<typename C = Coefficients, typename Arg,
      std::enable_if_t<Eigen3::is_Eigen_matrix_v<Arg> or Eigen3::is_ToEuclideanExpr_v<Arg>, int> = 0>
#endif
