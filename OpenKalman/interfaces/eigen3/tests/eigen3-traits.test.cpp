...
TEST(eigen3, Eigen_Matrix)
{
  ...
  static_assert(max_indices_of_v<Eigen::Matrix<double, 0, 0>> == 0);
  static_assert(max_indices_of_v<Eigen::Matrix<double, 2, 0>> == 0);
  static_assert(max_indices_of_v<Eigen::Matrix<double, 0, 2>> == 0);
...
TEST(eigen3, Eigen_PartialReduxExpr)
{
  ...
  EXPECT_EQ(Eigen3::EigenWrapper{cxb.array().matrix()}.colwise().sum().imag()(0,0), 8); // \todo currently does not compile
  ...
  EXPECT_EQ(Eigen3::EigenWrapper{cxb.array().matrix()}.imag().colwise().sum()(0,0), 8); // \todo currently causes a seg fault
...
TEST(eigen3, Eigen_SelfAdjointView)
{
  ...
  static_assert(element_settable<decltype(salv22), std::size_t, std::size_t>);
  ...
  static_assert(element_settable<decltype(sauv22), std::size_t, std::size_t>);
  ...
  static_assert(element_settable<decltype(salv22c), std::size_t, std::size_t>);
...
TEST(eigen3, Eigen_TriangularView)
{
  ...
  static_assert(element_settable<decltype(tlv22), std::size_t, std::size_t>);
  ...
  static_assert(element_settable<decltype(tuv22), std::size_t, std::size_t>);
  ...
  static_assert(element_settable<decltype(tlv22c), std::size_t, std::size_t>);
