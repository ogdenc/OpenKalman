...
namespace OpenKalman::test
{
  ...
  struct TestComparison<Arg1, Arg2, Err, std::enable_if_t<Eigen3::native_eigen_dense<Arg1> and Eigen3::native_eigen_dense<Arg2> and
    (std::is_arithmetic_v<Err> or Eigen3::native_eigen_dense<Err>)>>
#endif
  ...
  private:
    ...
    using A = std::conditional_t<Eigen3::native_eigen_general<Arg1>, Arg1, Arg2>;
