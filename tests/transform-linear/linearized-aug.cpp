...
TEST_F(transform_linear, linearized_augmented_order1)
{
  Mat2 a {1, 2,
          4, 3};
  Mat2 an {3, 4,
...
TEST_F(transform_linear, linearized_dual_augmented)
{
  Mat2 a {1, 2,
          4, 3};
  Mat2 an {3, 4,
  ...
  EXPECT_TRUE(is_near(covariance(out1), Mat2 {255, 530, 530, 1235}));
  EXPECT_TRUE(is_near(cross, Mat2 {70, 180, 80, 170}));
  EXPECT_TRUE(is_near(covariance(y), Mat2 {30, 20, 20, 30}));
}

TEST_F(transform_linear, linearized_augmented_order2)
{
  Mat2 a {1, 2,
          4, 3};
  Mat2 an {3, 4,
