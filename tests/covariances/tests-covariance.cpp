...
TEST_F(covariance_tests, Covariance_make)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance(CovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(make_covariance(CovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<CovSA2l>().get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(make_covariance<CovSA2u>().get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<C>(SA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(make_covariance<C>(SA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<C, SA2l>().get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(make_covariance<C, SA2u>().get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance(SA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(make_covariance<C>(SA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<C>(Mat2 {9, 3, 3, 10}.nested_matrix()).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<C, M2>().get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance(Mat2 {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<Mat2>().get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(make_covariance<C>(9., 3, 3, 10).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_overloads)
{
  ...
  CovSA2l covsa2l {9, 3, 3, 10}; EXPECT_TRUE(is_near(square_root(covsa2l).get_triangular_nested_matrix(), Mat2 {3, 0, 1, 3}));
  EXPECT_TRUE(is_near(square_root(covsa2l).get_self_adjoint_nested_matrix(), Mat2 {9, 3, 3, 10}));
  auto sqcovsa2l = square_root(CovSA2l {9, 3, 3, 10}); EXPECT_TRUE(is_near(sqcovsa2l.get_triangular_nested_matrix(), Mat2 {3, 0, 1, 3}));
  EXPECT_TRUE(is_near(sqcovsa2l.get_self_adjoint_nested_matrix(), Mat2 {9, 3, 3, 10}));
  ...
  CovT2l covt2l {9, 3, 3, 10}; EXPECT_TRUE(is_near(square_root(covt2l).get_triangular_nested_matrix(), Mat2 {3, 0, 1, 3}));
  EXPECT_TRUE(is_near(square_root(covt2l).get_self_adjoint_nested_matrix(), Mat2 {9, 3, 3, 10}));
  auto sqcovt2l = square_root(CovT2l {9, 3, 3, 10}); EXPECT_TRUE(is_near(sqcovt2l.get_triangular_nested_matrix(), Mat2 {3, 0, 1, 3}));
  EXPECT_TRUE(is_near(sqcovt2l.get_self_adjoint_nested_matrix(), Mat2 {9, 3, 3, 10}));
