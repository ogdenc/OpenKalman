...
TEST_F(covariance_tests, Covariance_addition)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + CovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + covi2).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + covz2).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + CovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + covi2).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + covz2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + CovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + covi2).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + CovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + covi2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovD2 {9, 10} + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovD2 {9, 10} + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovD2 {9, 10} + CovT2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovD2 {9, 10} + CovT2u {4, 2, 2, 5}).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covi2 + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covi2 + CovSA2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((covi2 + CovT2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covi2 + CovT2u {4, 2, 2, 5}).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covz2 + CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covz2 + CovSA2u {4, 2, 2, 5}).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_addition_mixed)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + SqCovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + sqcovi2).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l {9, 3, 3, 10} + sqcovz2).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + SqCovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + sqcovi2).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u {9, 3, 3, 10} + sqcovz2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + SqCovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((CovT2l {9, 3, 3, 10} + sqcovi2).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + SqCovD2 {4, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovT2u {9, 3, 3, 10} + sqcovi2).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_subtraction)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covz2 - CovSA2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covz2 - CovSA2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::lower_storage_triangle<decltype((covz2 - CovT2l {4, 2, 2, 5}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covz2 - CovT2u {4, 2, 2, 5}).base_matrix())>);
  static_assert(diagonal_matrix<decltype((covz2 - CovD2 {4, 5}).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_covariance)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covi2 * CovSA2l {9, 3, 3, 10}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covi2 * CovSA2u {9, 3, 3, 10}).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covi2 * SqCovSA2l {9, 3, 3, 10}).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((covi2 * SqCovSA2u {9, 3, 3, 10}).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_TypedMatrix)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((covSA2l * mati2).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((covSA2u * mati2).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_scalar)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l(p1) * 2).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u(p1) * 2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((2 * CovSA2l(p1)).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((2 * CovSA2u(p1)).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((CovSA2l(p1) / 0.5).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype((CovSA2u(p1) / 0.5).base_matrix())>);
...
TEST_F(covariance_tests, Covariance_scale)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype(scale(CovSA2l(p1), 2).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype(scale(CovSA2u(p1), 2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype(inverse_scale(CovSA2l(p1), 2).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype(inverse_scale(CovSA2u(p1), 2).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype(scale(CovSA2l(p1), a1).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype(scale(CovSA2u(p1), a1).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype(scale(CovSA3l(q1), b1).base_matrix())>);
  static_assert(Eigen3::upper_storage_triangle<decltype(scale(CovSA3u(q1), b1).base_matrix())>);
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype(scale(CovD3 {4, 5, 6}, b1).base_matrix())>);
}
...
TEST_F(covariance_tests, TypedMatrix_mult_Covariance)
{
  ...
  static_assert(Eigen3::lower_storage_triangle<decltype((mati2 * covSA2l).base_matrix())>);
  ...
  static_assert(Eigen3::upper_storage_triangle<decltype((mati2 * covSA2u).base_matrix())>);
