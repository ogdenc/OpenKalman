...
TEST_F(covariance_tests, Covariance_addition)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + covz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + covi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovD2 {9, 10} + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovD2 {9, 10} + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovD2 {9, 10} + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovD2 {9, 10} + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covi2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covi2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((covi2 + CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covi2 + CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covz2 + CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covz2 + CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_addition_mixed)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u {9, 3, 3, 10} + sqcovz2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((CovT2l {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + SqCovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovT2u {9, 3, 3, 10} + sqcovi2).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_subtraction)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covz2 - CovSA2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covz2 - CovSA2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::lower_triangular_storage<decltype((covz2 - CovT2l {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covz2 - CovT2u {4, 2, 2, 5}).get_self_adjoint_nested_matrix())>);
  static_assert(diagonal_matrix<decltype((covz2 - CovD2 {4, 5}).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_covariance)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covi2 * CovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covi2 * CovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covi2 * SqCovSA2l {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((covi2 * SqCovSA2u {9, 3, 3, 10}).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_TypedMatrix)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((covSA2l * mati2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((covSA2u * mati2).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_mult_scalar)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l(p1) * 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u(p1) * 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((2 * CovSA2l(p1)).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((2 * CovSA2u(p1)).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((CovSA2l(p1) / 0.5).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype((CovSA2u(p1) / 0.5).get_self_adjoint_nested_matrix())>);
...
TEST_F(covariance_tests, Covariance_scale)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(inverse_scale(CovSA2l(p1), 2).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(inverse_scale(CovSA2u(p1), 2).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(scale(CovSA2l(p1), a1).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(scale(CovSA2u(p1), a1).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(scale(CovD2 {1, 2}, a1).get_self_adjoint_nested_matrix())>);
  ...
  using CovD3 = Covariance<Coefficients<angle::Radians, Axis, angle::Radians>, DiagonalMatrix<eigen_matrix_t<double, 3, 1>>>;
  Mat3 q1 {4, 2, 2,
           2, 5, 3,
           2, 3, 6};
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(scale(CovSA3l(q1), b1).get_self_adjoint_nested_matrix())>);
  static_assert(Eigen3::upper_triangular_storage<decltype(scale(CovSA3u(q1), b1).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype(scale(CovD3 {4, 5, 6}, b1).get_self_adjoint_nested_matrix())>);
}
...
TEST_F(covariance_tests, TypedMatrix_mult_Covariance)
{
  ...
  static_assert(Eigen3::lower_triangular_storage<decltype((mati2 * covSA2l).get_self_adjoint_nested_matrix())>);
  ...
  static_assert(Eigen3::upper_triangular_storage<decltype((mati2 * covSA2u).get_self_adjoint_nested_matrix())>);
