...
namespace OpenKalman
{
  ...
  template<typename T>
  struct is_diagonal<T, std::enable_if_t<is_zero_v<T> or is_identity_v<T>>> : std::true_type {};
  ...
  {
    using no_type = T; ///< This type is defined only if Dist is not a distribution.
  };
